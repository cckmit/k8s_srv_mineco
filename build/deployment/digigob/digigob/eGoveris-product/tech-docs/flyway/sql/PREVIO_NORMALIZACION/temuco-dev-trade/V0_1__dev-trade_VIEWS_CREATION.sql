CREATE DATABASE  IF NOT EXISTS `numerador_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `numerador_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: numerador_trade
-- ------------------------------------------------------
...
/*!50001 VIEW sade_sector_usuario AS select eu_trade.edt_sade_sector_usuario.ID_SECTOR_USUARIO AS ID_SECTOR_USUARIO,eu_trade.edt_sade_sector_usuario.ID_SECTOR_INTERNO AS ID_SECTOR_INTERNO,eu_trade.edt_sade_sector_usuario.NOMBRE_USUARIO AS NOMBRE_USUARIO,eu_trade.edt_sade_sector_usuario.PROCESO AS PROCESO,eu_trade.edt_sade_sector_usuario.ESTADO_REGISTRO AS ESTADO_REGISTRO,eu_trade.edt_sade_sector_usuario.VERSION AS VERSION,eu_trade.edt_sade_sector_usuario.FECHA_CREACION AS FECHA_CREACION,eu_trade.edt_sade_sector_usuario.USUARIO_CREACION AS USUARIO_CREACION,eu_trade.edt_sade_sector_usuario.FECHA_MODIFICACION AS FECHA_MODIFICACION,eu_trade.edt_sade_sector_usuario.USUARIO_MODIFICACION AS USUARIO_MODIFICACION,eu_trade.edt_sade_sector_usuario.CARGO_ID AS CARGO_ID from eu_trade.edt_sade_sector_usuario */;
...
CREATE DATABASE  IF NOT EXISTS `tad_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `tad_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: tad_trade
-- ------------------------------------------------------
-- Server version	5.7.18
...
-- Dump completed on 2017-08-30 10:00:25
CREATE DATABASE  IF NOT EXISTS `gedo_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `gedo_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: gedo_trade
-- ------------------------------------------------------
-- Server version	5.7.18
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=egov@`%` SQL SECURITY DEFINER */
/*!50001 VIEW property_configuration AS select eu_trade.property_configuration.CLAVE AS CLAVE,eu_trade.property_configuration.VALOR AS VALOR,eu_trade.property_configuration.CONFIGURACION AS CONFIGURACION from eu_trade.property_configuration */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
CREATE DATABASE  IF NOT EXISTS `ee_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ee_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: ee_trade
-- ------------------------------------------------------
-- Server version	5.7.18
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=egov@`%` SQL SECURITY DEFINER */
/*!50001 VIEW gedo_documento AS select gedo_trade.gedo_documento.ID AS ID,gedo_trade.gedo_documento.NUMERO AS NUMERO,gedo_trade.gedo_documento.NUMEROESPECIAL AS NUMEROESPECIAL,gedo_trade.gedo_documento.REPARTICION AS REPARTICION,gedo_trade.gedo_documento.ANIO AS ANIO,gedo_trade.gedo_documento.MOTIVO AS MOTIVO,gedo_trade.gedo_documento.USUARIOGENERADOR AS USUARIOGENERADOR,gedo_trade.gedo_documento.FECHACREACION AS FECHACREACION,gedo_trade.gedo_documento.WORKFLOWORIGEN AS WORKFLOWORIGEN,gedo_trade.gedo_documento.NUMERO_SADE_PAPEL AS NUMERO_SADE_PAPEL,gedo_trade.gedo_documento.TIPO AS TIPO,gedo_trade.gedo_documento.SISTEMAORIGEN AS SISTEMAORIGEN,gedo_trade.gedo_documento.SISTEMAINICIADOR AS SISTEMAINICIADOR,gedo_trade.gedo_documento.USUARIOINICIADOR AS USUARIOINICIADOR,gedo_trade.gedo_documento.TIPORESERVA AS TIPORESERVA,gedo_trade.gedo_documento.VERSION AS VERSION,gedo_trade.gedo_documento.CCOO_ID_DOC AS CCOO_ID_DOC,gedo_trade.gedo_documento.CCOO_FECHA_CREACION AS CCOO_FECHA_CREACION,gedo_trade.gedo_documento.APODERADO AS APODERADO,gedo_trade.gedo_documento.REPARTICION_ACTUAL AS REPARTICION_ACTUAL,gedo_trade.gedo_documento.FECHA_MODIFICACION AS FECHA_MODIFICACION,gedo_trade.gedo_documento.ID_GUARDA_DOCUMENTAL AS ID_GUARDA_DOCUMENTAL,gedo_trade.gedo_documento.PESO AS PESO,gedo_trade.gedo_documento.MOTIVO_DEPURACION AS MOTIVO_DEPURACION,gedo_trade.gedo_documento.FECHA_DEPURACION AS FECHA_DEPURACION from gedo_trade.gedo_documento */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=egov@`%` SQL SECURITY DEFINER */
/*!50001 VIEW gedo_tipodocumento AS select gedo_trade.gedo_tipodocumento.ID AS ID,gedo_trade.gedo_tipodocumento.NOMBRE AS NOMBRE,gedo_trade.gedo_tipodocumento.ACRONIMO AS ACRONIMO,gedo_trade.gedo_tipodocumento.DESCRIPCION AS DESCRIPCION,gedo_trade.gedo_tipodocumento.ESESPECIAL AS ESESPECIAL,gedo_trade.gedo_tipodocumento.TIENETOKEN AS TIENETOKEN,gedo_trade.gedo_tipodocumento.TIENETEMPLATE AS TIENETEMPLATE,gedo_trade.gedo_tipodocumento.ESTADO AS ESTADO,gedo_trade.gedo_tipodocumento.IDTIPODOCUMENTOSADE AS IDTIPODOCUMENTOSADE,gedo_trade.gedo_tipodocumento.CODIGOTIPODOCUMENTOSADE AS CODIGOTIPODOCUMENTOSADE,gedo_trade.gedo_tipodocumento.ESCONFIDENCIAL AS ESCONFIDENCIAL,gedo_trade.gedo_tipodocumento.ESFIRMAEXTERNA AS ESFIRMAEXTERNA,gedo_trade.gedo_tipodocumento.ESMANUAL AS ESMANUAL,gedo_trade.gedo_tipodocumento.ESAUTOMATICA AS ESAUTOMATICA,gedo_trade.gedo_tipodocumento.ESFIRMACONJUNTA AS ESFIRMACONJUNTA,gedo_trade.gedo_tipodocumento.FAMILIA AS FAMILIA,gedo_trade.gedo_tipodocumento.TIENEAVISO AS TIENEAVISO,gedo_trade.gedo_tipodocumento.PERMITE_EMBEBIDOS AS PERMITE_EMBEBIDOS,gedo_trade.gedo_tipodocumento.TIPOPRODUCCION AS TIPOPRODUCCION,gedo_trade.gedo_tipodocumento.ES_NOTIFICABLE AS ES_NOTIFICABLE,gedo_trade.gedo_tipodocumento.VERSION AS VERSION,gedo_trade.gedo_tipodocumento.TAMANO AS TAMANO,gedo_trade.gedo_tipodocumento.ESOCULTO AS ESOCULTO,gedo_trade.gedo_tipodocumento.ES_COMUNICABLE AS ES_COMUNICABLE,gedo_trade.gedo_tipodocumento.USUARIO_CREADOR AS USUARIO_CREADOR,gedo_trade.gedo_tipodocumento.FECHA_CREACION AS FECHA_CREACION,gedo_trade.gedo_tipodocumento.ESFIRMAEXTERNACONENCABEZADO AS ESFIRMAEXTERNACONENCABEZADO from gedo_trade.gedo_tipodocumento */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=egov@`%` SQL SECURITY DEFINER */
/*!50001 VIEW sade_reparticion AS select eu_trade.edt_sade_reparticion.id_reparticion AS id_reparticion,eu_trade.edt_sade_reparticion.CODIGO_REPARTICION AS CODIGO_REPARTICION,eu_trade.edt_sade_reparticion.CODIGO_REPAR_INTER AS CODIGO_REPAR_INTER,eu_trade.edt_sade_reparticion.NOMBRE_REPARTICION AS NOMBRE_REPARTICION,eu_trade.edt_sade_reparticion.VIGENCIA_DESDE AS VIGENCIA_DESDE,eu_trade.edt_sade_reparticion.VIGENCIA_HASTA AS VIGENCIA_HASTA,eu_trade.edt_sade_reparticion.NUMERO AS NUMERO,eu_trade.edt_sade_reparticion.PISO AS PISO,eu_trade.edt_sade_reparticion.OFICINA AS OFICINA,eu_trade.edt_sade_reparticion.TELEFONO AS TELEFONO,eu_trade.edt_sade_reparticion.FAX AS FAX,eu_trade.edt_sade_reparticion.EMAIL AS EMAIL,eu_trade.edt_sade_reparticion.ID_ESTRUCTURA AS ID_ESTRUCTURA,eu_trade.edt_sade_reparticion.EN_RED AS EN_RED,eu_trade.edt_sade_reparticion.SECTOR_MESA AS SECTOR_MESA,eu_trade.edt_sade_reparticion.VERSION AS VERSION,eu_trade.edt_sade_reparticion.FECHA_CREACION AS FECHA_CREACION,eu_trade.edt_sade_reparticion.USUARIO_CREACION AS USUARIO_CREACION,eu_trade.edt_sade_reparticion.FECHA_MODIFICACION AS FECHA_MODIFICACION,eu_trade.edt_sade_reparticion.USUARIO_MODIFICACION AS USUARIO_MODIFICACION,eu_trade.edt_sade_reparticion.ESTADO_REGISTRO AS ESTADO_REGISTRO,eu_trade.edt_sade_reparticion.ES_DGTAL AS ES_DGTAL,eu_trade.edt_sade_reparticion.REP_PADRE AS REP_PADRE,eu_trade.edt_sade_reparticion.COD_DGTAL AS COD_DGTAL,eu_trade.edt_sade_reparticion.ID_JURISDICCION AS ID_JURISDICCION,eu_trade.edt_sade_reparticion.MINISTERIO AS MINISTERIO,eu_trade.edt_sade_reparticion.ADMINISTRADOR_PRESUPUESTO AS ADMINISTRADOR_PRESUPUESTO,eu_trade.edt_sade_reparticion.calle AS calle from eu_trade.edt_sade_reparticion */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-08-30 10:00:27
CREATE DATABASE  IF NOT EXISTS `mnt_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `mnt_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
...
CREATE DATABASE  IF NOT EXISTS `eu_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `eu_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: eu_trade
-- ------------------------------------------------------
-- Server version	5.7.18
