CREATE DATABASE  IF NOT EXISTS `dev_numerador_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dev_numerador_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dev_numerador_trade
-- ------------------------------------------------------
...
/*!50001 VIEW sade_sector_usuario AS select dev_edt_trade.edt_sade_sector_usuario.ID_SECTOR_USUARIO AS ID_SECTOR_USUARIO,dev_edt_trade.edt_sade_sector_usuario.ID_SECTOR_INTERNO AS ID_SECTOR_INTERNO,dev_edt_trade.edt_sade_sector_usuario.NOMBRE_USUARIO AS NOMBRE_USUARIO,dev_edt_trade.edt_sade_sector_usuario.PROCESO AS PROCESO,dev_edt_trade.edt_sade_sector_usuario.ESTADO_REGISTRO AS ESTADO_REGISTRO,dev_edt_trade.edt_sade_sector_usuario.VERSION AS VERSION,dev_edt_trade.edt_sade_sector_usuario.FECHA_CREACION AS FECHA_CREACION,dev_edt_trade.edt_sade_sector_usuario.USUARIO_CREACION AS USUARIO_CREACION,dev_edt_trade.edt_sade_sector_usuario.FECHA_MODIFICACION AS FECHA_MODIFICACION,dev_edt_trade.edt_sade_sector_usuario.USUARIO_MODIFICACION AS USUARIO_MODIFICACION,dev_edt_trade.edt_sade_sector_usuario.CARGO_ID AS CARGO_ID from dev_edt_trade.edt_sade_sector_usuario */;
...
CREATE DATABASE  IF NOT EXISTS `dev_vuc_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dev_vuc_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dev_vuc_trade
-- ------------------------------------------------------
-- Server version	5.7.18
...
-- Dump completed on 2017-08-30 10:00:25
CREATE DATABASE  IF NOT EXISTS `dev_deo_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dev_deo_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dev_deo_trade
-- ------------------------------------------------------
-- Server version	5.7.18
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=egov@`%` SQL SECURITY DEFINER */
/*!50001 VIEW property_configuration AS select dev_edt_trade.property_configuration.CLAVE AS CLAVE,dev_edt_trade.property_configuration.VALOR AS VALOR,dev_edt_trade.property_configuration.CONFIGURACION AS CONFIGURACION from dev_edt_trade.property_configuration */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
CREATE DATABASE  IF NOT EXISTS `dev_te_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dev_te_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dev_te_trade
-- ------------------------------------------------------
-- Server version	5.7.18
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=egov@`%` SQL SECURITY DEFINER */
/*!50001 VIEW gedo_documento AS select dev_deo_trade.gedo_documento.ID AS ID,dev_deo_trade.gedo_documento.NUMERO AS NUMERO,dev_deo_trade.gedo_documento.NUMEROESPECIAL AS NUMEROESPECIAL,dev_deo_trade.gedo_documento.REPARTICION AS REPARTICION,dev_deo_trade.gedo_documento.ANIO AS ANIO,dev_deo_trade.gedo_documento.MOTIVO AS MOTIVO,dev_deo_trade.gedo_documento.USUARIOGENERADOR AS USUARIOGENERADOR,dev_deo_trade.gedo_documento.FECHACREACION AS FECHACREACION,dev_deo_trade.gedo_documento.WORKFLOWORIGEN AS WORKFLOWORIGEN,dev_deo_trade.gedo_documento.NUMERO_SADE_PAPEL AS NUMERO_SADE_PAPEL,dev_deo_trade.gedo_documento.TIPO AS TIPO,dev_deo_trade.gedo_documento.SISTEMAORIGEN AS SISTEMAORIGEN,dev_deo_trade.gedo_documento.SISTEMAINICIADOR AS SISTEMAINICIADOR,dev_deo_trade.gedo_documento.USUARIOINICIADOR AS USUARIOINICIADOR,dev_deo_trade.gedo_documento.TIPORESERVA AS TIPORESERVA,dev_deo_trade.gedo_documento.VERSION AS VERSION,dev_deo_trade.gedo_documento.CCOO_ID_DOC AS CCOO_ID_DOC,dev_deo_trade.gedo_documento.CCOO_FECHA_CREACION AS CCOO_FECHA_CREACION,dev_deo_trade.gedo_documento.APODERADO AS APODERADO,dev_deo_trade.gedo_documento.REPARTICION_ACTUAL AS REPARTICION_ACTUAL,dev_deo_trade.gedo_documento.FECHA_MODIFICACION AS FECHA_MODIFICACION,dev_deo_trade.gedo_documento.ID_GUARDA_DOCUMENTAL AS ID_GUARDA_DOCUMENTAL,dev_deo_trade.gedo_documento.PESO AS PESO,dev_deo_trade.gedo_documento.MOTIVO_DEPURACION AS MOTIVO_DEPURACION,dev_deo_trade.gedo_documento.FECHA_DEPURACION AS FECHA_DEPURACION from dev_deo_trade.gedo_documento */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=egov@`%` SQL SECURITY DEFINER */
/*!50001 VIEW gedo_tipodocumento AS select dev_deo_trade.gedo_tipodocumento.ID AS ID,dev_deo_trade.gedo_tipodocumento.NOMBRE AS NOMBRE,dev_deo_trade.gedo_tipodocumento.ACRONIMO AS ACRONIMO,dev_deo_trade.gedo_tipodocumento.DESCRIPCION AS DESCRIPCION,dev_deo_trade.gedo_tipodocumento.ESESPECIAL AS ESESPECIAL,dev_deo_trade.gedo_tipodocumento.TIENETOKEN AS TIENETOKEN,dev_deo_trade.gedo_tipodocumento.TIENETEMPLATE AS TIENETEMPLATE,dev_deo_trade.gedo_tipodocumento.ESTADO AS ESTADO,dev_deo_trade.gedo_tipodocumento.IDTIPODOCUMENTOSADE AS IDTIPODOCUMENTOSADE,dev_deo_trade.gedo_tipodocumento.CODIGOTIPODOCUMENTOSADE AS CODIGOTIPODOCUMENTOSADE,dev_deo_trade.gedo_tipodocumento.ESCONFIDENCIAL AS ESCONFIDENCIAL,dev_deo_trade.gedo_tipodocumento.ESFIRMAEXTERNA AS ESFIRMAEXTERNA,dev_deo_trade.gedo_tipodocumento.ESMANUAL AS ESMANUAL,dev_deo_trade.gedo_tipodocumento.ESAUTOMATICA AS ESAUTOMATICA,dev_deo_trade.gedo_tipodocumento.ESFIRMACONJUNTA AS ESFIRMACONJUNTA,dev_deo_trade.gedo_tipodocumento.FAMILIA AS FAMILIA,dev_deo_trade.gedo_tipodocumento.TIENEAVISO AS TIENEAVISO,dev_deo_trade.gedo_tipodocumento.PERMITE_EMBEBIDOS AS PERMITE_EMBEBIDOS,dev_deo_trade.gedo_tipodocumento.TIPOPRODUCCION AS TIPOPRODUCCION,dev_deo_trade.gedo_tipodocumento.ES_NOTIFICABLE AS ES_NOTIFICABLE,dev_deo_trade.gedo_tipodocumento.VERSION AS VERSION,dev_deo_trade.gedo_tipodocumento.TAMANO AS TAMANO,dev_deo_trade.gedo_tipodocumento.ESOCULTO AS ESOCULTO,dev_deo_trade.gedo_tipodocumento.ES_COMUNICABLE AS ES_COMUNICABLE,dev_deo_trade.gedo_tipodocumento.USUARIO_CREADOR AS USUARIO_CREADOR,dev_deo_trade.gedo_tipodocumento.FECHA_CREACION AS FECHA_CREACION,dev_deo_trade.gedo_tipodocumento.ESFIRMAEXTERNACONENCABEZADO AS ESFIRMAEXTERNACONENCABEZADO from dev_deo_trade.gedo_tipodocumento */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=egov@`%` SQL SECURITY DEFINER */
/*!50001 VIEW sade_reparticion AS select dev_edt_trade.edt_sade_reparticion.id_reparticion AS id_reparticion,dev_edt_trade.edt_sade_reparticion.CODIGO_REPARTICION AS CODIGO_REPARTICION,dev_edt_trade.edt_sade_reparticion.CODIGO_REPAR_INTER AS CODIGO_REPAR_INTER,dev_edt_trade.edt_sade_reparticion.NOMBRE_REPARTICION AS NOMBRE_REPARTICION,dev_edt_trade.edt_sade_reparticion.VIGENCIA_DESDE AS VIGENCIA_DESDE,dev_edt_trade.edt_sade_reparticion.VIGENCIA_HASTA AS VIGENCIA_HASTA,dev_edt_trade.edt_sade_reparticion.NUMERO AS NUMERO,dev_edt_trade.edt_sade_reparticion.PISO AS PISO,dev_edt_trade.edt_sade_reparticion.OFICINA AS OFICINA,dev_edt_trade.edt_sade_reparticion.TELEFONO AS TELEFONO,dev_edt_trade.edt_sade_reparticion.FAX AS FAX,dev_edt_trade.edt_sade_reparticion.EMAIL AS EMAIL,dev_edt_trade.edt_sade_reparticion.ID_ESTRUCTURA AS ID_ESTRUCTURA,dev_edt_trade.edt_sade_reparticion.EN_RED AS EN_RED,dev_edt_trade.edt_sade_reparticion.SECTOR_MESA AS SECTOR_MESA,dev_edt_trade.edt_sade_reparticion.VERSION AS VERSION,dev_edt_trade.edt_sade_reparticion.FECHA_CREACION AS FECHA_CREACION,dev_edt_trade.edt_sade_reparticion.USUARIO_CREACION AS USUARIO_CREACION,dev_edt_trade.edt_sade_reparticion.FECHA_MODIFICACION AS FECHA_MODIFICACION,dev_edt_trade.edt_sade_reparticion.USUARIO_MODIFICACION AS USUARIO_MODIFICACION,dev_edt_trade.edt_sade_reparticion.ESTADO_REGISTRO AS ESTADO_REGISTRO,dev_edt_trade.edt_sade_reparticion.ES_DGTAL AS ES_DGTAL,dev_edt_trade.edt_sade_reparticion.REP_PADRE AS REP_PADRE,dev_edt_trade.edt_sade_reparticion.COD_DGTAL AS COD_DGTAL,dev_edt_trade.edt_sade_reparticion.ID_JURISDICCION AS ID_JURISDICCION,dev_edt_trade.edt_sade_reparticion.MINISTERIO AS MINISTERIO,dev_edt_trade.edt_sade_reparticion.ADMINISTRADOR_PRESUPUESTO AS ADMINISTRADOR_PRESUPUESTO,dev_edt_trade.edt_sade_reparticion.calle AS calle from dev_edt_trade.edt_sade_reparticion */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-08-30 10:00:27
CREATE DATABASE  IF NOT EXISTS `dev_mnt_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dev_mnt_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dev_mnt_trade
-- ------------------------------------------------------
-- Server version	5.7.18
...
CREATE DATABASE  IF NOT EXISTS `dev_edt_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dev_edt_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dev_edt_trade
-- ------------------------------------------------------
-- Server version	5.7.18
