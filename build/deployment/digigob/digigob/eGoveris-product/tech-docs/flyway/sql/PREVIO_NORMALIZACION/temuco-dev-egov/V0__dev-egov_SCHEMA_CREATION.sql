...
CREATE TABLE ccoo_comunicacion (
  ...
  USUARIO_CREADOR varchar(4000) DEFAULT NULL,
  ...
  NOMBRE_COMPLETO_USUARIO varchar(4000) DEFAULT NULL,
  TIENE_ADJUNTOS char(1) DEFAULT NULL,
  NRO_COMUNICACION_RESPONDIDA varchar(4000) DEFAULT NULL,
  PRIMARY KEY (ID),
...
CREATE TABLE ccoo_comunicacion_destino (
  ...
  NOMBRE_USUARIO varchar(4000) DEFAULT NULL,
  COPIA char(1) DEFAULT NULL,
  COPIA_OCULTA char(1) DEFAULT NULL,
  ID int(10) NOT NULL,
  REPARTICION_EXTERNO varchar(4000) DEFAULT NULL,
  LEIDO datetime DEFAULT NULL,
  MESA_EXTERNO varchar(4000) DEFAULT NULL,
  FECHA_ELIMINACION_BANDEJA datetime DEFAULT NULL,
  MESA_DESTINO varchar(4000) DEFAULT NULL,
  USUARIO_CON_LICENCIA varchar(4000) DEFAULT NULL,
  REENVIO_POR varchar(4000) DEFAULT NULL,
  USUARIO_IMPRESOR varchar(4000) DEFAULT NULL,
...
CREATE TABLE datos_variables_tipo_doc_aud (
  ...
  NOMBRE_METADATO varchar(4000) DEFAULT NULL,
  TIPO varchar(4000) DEFAULT NULL,
...
CREATE TABLE documento_datos_variables (
  ...
  OBLIGATORIEDAD char(1) DEFAULT NULL,
  NOMBRE_METADATO varchar(4000) DEFAULT NULL,
  VALOR_METADATO varchar(4000) DEFAULT NULL,
  ORDEN decimal(10,0) NOT NULL,
  PRIMARY KEY (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE gedo_archivo_de_trabajo (
  ID int(11) NOT NULL,
  NOMBRE_ARCHIVO varchar(4000) DEFAULT NULL,
  DEFINITIVO char(1) DEFAULT NULL,
  USUARIOASOCIADOR varchar(4000) DEFAULT NULL,
  PATHRELATIVO varchar(4000) DEFAULT NULL,
  FECHAASOCIACION datetime DEFAULT NULL,
  IDTASK varchar(4000) DEFAULT NULL,
  ID_GUARDA_DOCUMENTAL varchar(4000) DEFAULT NULL,
...
CREATE TABLE gedo_aviso (
  ID int(10) NOT NULL,
  USUARIORECEPTOR varchar(4000) NOT NULL,
  USUARIOACCION varchar(4000) NOT NULL,
  FECHAACCION datetime NOT NULL,
  FECHAENVIO datetime NOT NULL,
  REDIRIGIDOPOR varchar(4000) DEFAULT NULL,
  MOTIVO varchar(4000) DEFAULT NULL,
  MOTIVORECHAZO varchar(4000) DEFAULT NULL,
  DOCUMENTO decimal(10,0) DEFAULT NULL,
  REFERENCIADOCUMENTO varchar(4000) DEFAULT NULL,
  NUMEROSADEPAPEL varchar(4000) DEFAULT NULL,
  NUMEROESPECIAL varchar(4000) DEFAULT NULL,
  PRIMARY KEY (ID),
...
CREATE TABLE gedo_comentarios (
  ID decimal(10,0) NOT NULL DEFAULT '0',
  ID_TASK varchar(4000) NOT NULL,
  USUARIO varchar(4000) NOT NULL,
  FECHA datetime NOT NULL,
  WORKFLOWORIGEN varchar(4000) NOT NULL,
...
CREATE TABLE gedo_documento (
  ID int(10) NOT NULL,
  NUMERO varchar(4000) DEFAULT NULL,
  NUMEROESPECIAL varchar(4000) DEFAULT NULL,
  REPARTICION varchar(4000) DEFAULT NULL,
  ANIO varchar(4000) DEFAULT NULL,
  MOTIVO varchar(4000) DEFAULT NULL,
  USUARIOGENERADOR varchar(4000) DEFAULT NULL,
  FECHACREACION datetime DEFAULT NULL,
  WORKFLOWORIGEN varchar(4000) DEFAULT NULL,
  NUMERO_SADE_PAPEL varchar(4000) DEFAULT NULL,
  TIPO decimal(10,0) DEFAULT NULL,
  SISTEMAORIGEN varchar(4000) DEFAULT NULL,
  SISTEMAINICIADOR varchar(4000) DEFAULT NULL,
  USUARIOINICIADOR varchar(4000) DEFAULT NULL,
  TIPORESERVA decimal(10,0) DEFAULT NULL,
  VERSION varchar(24) DEFAULT NULL,
  CCOO_ID_DOC decimal(10,0) DEFAULT NULL,
  CCOO_FECHA_CREACION datetime DEFAULT NULL,
  APODERADO varchar(4000) DEFAULT NULL,
  REPARTICION_ACTUAL varchar(4000) DEFAULT NULL,
  FECHA_MODIFICACION datetime DEFAULT NULL,
  ID_GUARDA_DOCUMENTAL varchar(4000) DEFAULT NULL,
  PESO double DEFAULT NULL,
  MOTIVO_DEPURACION varchar(4000) DEFAULT NULL,
...
CREATE TABLE gedo_firmantes (
  ID decimal(10,0) NOT NULL DEFAULT '0',
  WORKFLOWID varchar(4000) DEFAULT NULL,
  ORDEN decimal(10,0) DEFAULT NULL,
  USUARIOFIRMANTE varchar(4000) DEFAULT NULL,
...
CREATE TABLE gedo_historial (
  ID int(10) NOT NULL,
  USUARIO varchar(4000) NOT NULL,
  ACTIVIDAD varchar(4000) NOT NULL,
...
CREATE TABLE gedo_numeracionespecial (
  ID int(10) NOT NULL,
  CODIGOREPARTICION varchar(4000) DEFAULT NULL,
  ANIO varchar(4000) DEFAULT NULL,
  ...
  VERSION varchar(24) DEFAULT NULL,
  CODIGOECOSISTEMA varchar(4000) DEFAULT NULL,
  PRIMARY KEY (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE gedo_numeracionespecial_aud (
  ...
  TIPOOPERACION varchar(4000) DEFAULT NULL,
...
CREATE TABLE gedo_numerosusados (
  ...
  CODIGOREPARTICION varchar(4000) DEFAULT NULL,
  ANIO varchar(4000) DEFAULT NULL,
  NUMEROSADE varchar(4000) DEFAULT NULL,
  NUMEROESPECIAL varchar(4000) DEFAULT NULL,
  ESTADO varchar(4000) DEFAULT NULL,
  VERSION varchar(24) DEFAULT NULL,
  PRIMARY KEY (ID),
...
CREATE TABLE gedo_tipo_reserva (
  ID decimal(10,0) NOT NULL DEFAULT '0',
  RESERVA varchar(4000) DEFAULT NULL,
  PRIMARY KEY (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE gedo_tipodocumento (
  ...
  RESULTADO char(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (ID),
...
CREATE TABLE gedo_tipodocumento_aud (
  ...
  ACRONIMO varchar(4000) DEFAULT NULL,
  DESCRIPCION varchar(4000) DEFAULT NULL,
  ESESPECIAL char(1) DEFAULT NULL,
  ESMANUAL char(1) DEFAULT NULL,
  ESAUTOMATICA char(1) DEFAULT NULL,
  ...
  ESTADO varchar(4000) DEFAULT NULL,
  IDTIPODOCUMENTOSADE decimal(10,0) DEFAULT NULL,
  CODIGOTIPODOCUMENTOSADE varchar(4000) DEFAULT NULL,
  ESCONFIDENCIAL char(1) DEFAULT NULL,
...
CREATE TABLE gedo_tipodocumento_familia_aud (
  ID decimal(10,0) NOT NULL DEFAULT '0',
  FECHACREACION datetime DEFAULT NULL,
  NOMBREUSUARIO varchar(4000) DEFAULT NULL,
  ID_FAMILIA decimal(10,0) DEFAULT NULL,
  NOMBREFAMILIA varchar(4000) DEFAULT NULL,
  DESCRIPCION varchar(4000) DEFAULT NULL,
  ESTADO varchar(4000) DEFAULT NULL,
  PRIMARY KEY (ID)
);
...
CREATE TABLE jbpm4_deployment (
  ...
  STATE_ varchar(4000) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE jbpm4_deployprop (
  ...
  OBJNAME_ varchar(4000) DEFAULT NULL,
  KEY_ varchar(4000) DEFAULT NULL,
  STRINGVAL_ varchar(4000) DEFAULT NULL,
...
CREATE TABLE jbpm4_execution (
  DBID_ decimal(24,0) NOT NULL,
  CLASS_ varchar(4000) NOT NULL,
  DBVERSION_ decimal(10,0) NOT NULL,
  ACTIVITYNAME_ varchar(4000) DEFAULT NULL,
  PROCDEFID_ varchar(4000) DEFAULT NULL,
  HASVARS_ char(1) DEFAULT NULL,
  NAME_ varchar(4000) DEFAULT NULL,
  KEY_ varchar(4000) DEFAULT NULL,
  ID_ varchar(4000) DEFAULT NULL,
  STATE_ varchar(4000) DEFAULT NULL,
  SUSPHISTSTATE_ varchar(4000) DEFAULT NULL,
...
CREATE TABLE jbpm4_hist_actinst (
  ...
  TYPE_ varchar(4000) DEFAULT NULL,
  EXECUTION_ varchar(4000) DEFAULT NULL,
  ACTIVITY_NAME_ varchar(4000) DEFAULT NULL,
  START_ datetime DEFAULT NULL,
  END_ datetime DEFAULT NULL,
  DURATION_ decimal(24,0) DEFAULT NULL,
  TRANSITION_ varchar(4000) DEFAULT NULL,
...
CREATE TABLE jbpm4_hist_detail (
  ...
  CLASS_ varchar(4000) NOT NULL,
  DBVERSION_ decimal(10,0) NOT NULL,
  USERID_ varchar(4000) DEFAULT NULL,
  ...
  MESSAGE_ longtext,
  OLD_STR_ varchar(4000) DEFAULT NULL,
  NEW_STR_ varchar(4000) DEFAULT NULL,
...
CREATE TABLE jbpm4_hist_procinst (
  ...
  DURATION_ decimal(24,0) DEFAULT NULL,
  STATE_ varchar(4000) DEFAULT NULL,
  ENDACTIVITY_ varchar(4000) DEFAULT NULL,
  NEXTIDX_ decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE jbpm4_hist_task (
  ...
  DBVERSION_ decimal(10,0) NOT NULL,
  EXECUTION_ varchar(4000) DEFAULT NULL,
  OUTCOME_ varchar(4000) DEFAULT NULL,
  ASSIGNEE_ varchar(4000) DEFAULT NULL,
  PRIORITY_ decimal(10,0) DEFAULT NULL,
  STATE_ varchar(4000) DEFAULT NULL,
...
CREATE TABLE jbpm4_hist_var (
  DBID_ decimal(24,0) NOT NULL,
  DBVERSION_ decimal(10,0) NOT NULL,
  PROCINSTID_ varchar(4000) DEFAULT NULL,
  EXECUTIONID_ varchar(4000) DEFAULT NULL,
  VARNAME_ varchar(4000) DEFAULT NULL,
...
CREATE TABLE jbpm4_job (
  ...
  LOCKOWNER_ varchar(4000) DEFAULT NULL,
  ...
  SIGNAL_ varchar(4000) DEFAULT NULL,
  EVENT_ varchar(4000) DEFAULT NULL,
  REPEAT_ varchar(4000) DEFAULT NULL,
...
CREATE TABLE jbpm4_participation (
  DBID_ decimal(24,0) NOT NULL,
  DBVERSION_ decimal(10,0) NOT NULL,
  GROUPID_ varchar(4000) DEFAULT NULL,
  USERID_ varchar(4000) DEFAULT NULL,
  TYPE_ varchar(4000) DEFAULT NULL,
...
CREATE TABLE jbpm4_task (
  ...
  SUSPHISTSTATE_ varchar(4000) DEFAULT NULL,
  ASSIGNEE_ varchar(4000) DEFAULT NULL,
  FORM_ varchar(4000) DEFAULT NULL,
  PRIORITY_ decimal(10,0) DEFAULT NULL,
  CREATE_ datetime DEFAULT NULL,
  DUEDATE_ datetime DEFAULT NULL,
  PROGRESS_ decimal(10,0) DEFAULT NULL,
  SIGNALLING_ char(1) DEFAULT NULL,
  EXECUTION_ID_ varchar(4000) DEFAULT NULL,
  ACTIVITY_NAME_ varchar(4000) DEFAULT NULL,
  HASVARS_ char(1) DEFAULT NULL,
  SUPERTASK_ decimal(24,0) DEFAULT NULL,
  EXECUTION_ decimal(24,0) DEFAULT NULL,
  ...
  SWIMLANE_ decimal(24,0) DEFAULT NULL,
  TASKDEFNAME_ varchar(4000) DEFAULT NULL,
...
CREATE TABLE jbpm4_variable (
  ...
  DBVERSION_ decimal(10,0) NOT NULL,
  KEY_ varchar(4000) DEFAULT NULL,
  CONVERTER_ varchar(4000) DEFAULT NULL,
  ...
  STRING_VALUE_ varchar(4000) DEFAULT NULL,
...
CREATE TABLE messagerequest (
  ...
  MESSAGE_ID varchar(4000) DEFAULT NULL,
  EXECUTION_ID varchar(4000) DEFAULT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
...
CREATE TABLE trd_capitulo (
  ...
  ESTADO char(1) CHARACTER SET utf8 NOT NULL DEFAULT 'A' COMMENT 'A:Activo',
  PRIMARY KEY (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE trd_hscode (
  ...
  ID_SUBPARTIDANC bigint(20) NOT NULL,
  ESTADO char(1) CHARACTER SET utf8 DEFAULT 'A' COMMENT 'A:Activo',
  PRIMARY KEY (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE trd_producto_atributo (
  ...
  NOMBRE varchar(250) NOT NULL,
  NOMBRE_ING varchar(250) NOT NULL,
  VALOR varchar(250) NOT NULL,
  TIPO_DATO varchar(250) NOT NULL,
  TAMANO_DATO varchar(250) NOT NULL,
...
-- Dump completed on 2017-08-30 10:24:46
...
CREATE TABLE dashboard_menu (
  ...
  PERMISOS_ID int(19) DEFAULT NULL,
  POSITION int(11) NOT NULL,
  LABEL_ES varchar(255) NOT NULL,
  LABEL_EN varchar(255) DEFAULT NULL,
  Z_ICON_CLASS varchar(60) DEFAULT NULL,
  PROP_BASEURL varchar(60) DEFAULT NULL,
  TARGET_ZUL varchar(255) DEFAULT NULL,
  OTHERS varchar(255) DEFAULT NULL,
  ENABLED tinyint(1) NOT NULL,
  PRIMARY KEY (ID),
  KEY FK_PARENT_ID (PARENT_ID),
  CONSTRAINT FK_PARENT_ID FOREIGN KEY (PARENT_ID) REFERENCES dashboard_menu (ID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-08-30 10:24:47
...
--
-- Table structure for table `archivosbean`
--

DROP TABLE IF EXISTS archivosbean;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE archivosbean (
  ID_ARCHIVOSBEAN decimal(10,0) DEFAULT NULL,
  NOMBRE varchar(255) DEFAULT NULL,
  TIPOCOMUNICACIONOFICIAL varchar(255) DEFAULT NULL,
  IDAFRESCO varchar(255) DEFAULT NULL,
  ID decimal(10,0) DEFAULT NULL,
  ID_COMUNICACIONOFICIALBEAN decimal(10,0) DEFAULT NULL,
...
CREATE TABLE auditoria_accion (
  ID_TIPO_ACCION decimal(10,0) DEFAULT NULL,
  NOMBRE varchar(255) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `auditoriaco`
--

DROP TABLE IF EXISTS auditoriaco;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE auditoriaco (
  ID_AUDITORIA decimal(10,0) DEFAULT NULL,
  CODIGO_CARATULA varchar(255) DEFAULT NULL,
  ID_COMUNICACION_OFICIAL decimal(10,0) DEFAULT NULL,
  ID_VISTA_CO decimal(10,0) DEFAULT NULL,
  USUARIO_FROM varchar(255) DEFAULT NULL,
  USUARIO_TO varchar(255) DEFAULT NULL,
  FECHA_CREACION varchar(255) DEFAULT NULL,
  ID_TIPO_ACCION decimal(10,0) DEFAULT NULL,
  USUARIO_CREACION_VISTA varchar(255) DEFAULT NULL,
  USUARIO_MODIFICACION varchar(255) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `auditoriaco_no_electronico`
--

DROP TABLE IF EXISTS auditoriaco_no_electronico;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE auditoriaco_no_electronico (
  ID_AUDITORIANE decimal(10,0) DEFAULT NULL,
  CODIGO_COPIA_CARATULA varchar(255) DEFAULT NULL,
  ID_COMUNICACION_OFICIAL decimal(10,0) DEFAULT NULL,
  ID_VISTACOMESAENTRADAINBOX decimal(10,0) DEFAULT NULL,
  USUARIO_FROM varchar(255) DEFAULT NULL,
  USUARIO_TO varchar(255) DEFAULT NULL,
  FECHA_CREACION varchar(255) DEFAULT NULL,
  ID_TIPO_ACCION decimal(10,0) DEFAULT NULL,
...
--
-- Table structure for table `cargos_hist`
--

DROP TABLE IF EXISTS cargos_hist;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE cargos_hist (
  ID int(10) DEFAULT NULL,
  REVISION int(10) DEFAULT NULL,
  CARGO varchar(255) DEFAULT NULL,
  VISIBLE int(11) DEFAULT NULL,
...
--
-- Table structure for table `comunicaciones_oficiales_audi`
--

DROP TABLE IF EXISTS comunicaciones_oficiales_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE comunicaciones_oficiales_audi (
  ID_COMUNICACIONES_OFICIALES_AU decimal(10,0) DEFAULT NULL,
  CODIGO_CARATULA varchar(255) DEFAULT NULL,
  ID_COMUNICACIONOFICIAL decimal(10,0) DEFAULT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
  ACCION varchar(255) DEFAULT NULL,
  USUARIO_CREACION_COMUNICACION_ varchar(255) DEFAULT NULL,
  USUARIO_MODIFICACION varchar(255) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `copiacomunicacionoficial`
--

DROP TABLE IF EXISTS copiacomunicacionoficial;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE copiacomunicacionoficial (
  ID_COPIACOMUNICACIONOFICIAL decimal(10,0) DEFAULT NULL,
  CODIGOCOPIA varchar(255) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `datos_usuario2_tmp`
--

DROP TABLE IF EXISTS datos_usuario2_tmp;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE datos_usuario2_tmp (
  ID_DATO_USUARIO decimal(10,0) DEFAULT NULL,
  MAIL varchar(255) DEFAULT NULL,
  OCUPACION varchar(255) DEFAULT NULL,
  USER_ varchar(255) DEFAULT NULL,
  USUARIO varchar(255) DEFAULT NULL,
  ...
  SECRETARIO varchar(255) DEFAULT NULL,
  APELLIDO_NOMBRE varchar(255) DEFAULT NULL,
  ACEPTACION_TYC int(11) DEFAULT NULL,
  NUMERO_CUIT varchar(11) DEFAULT NULL,
  EXTERNALIZAR_FIRMA_EN_GEDO decimal(10,0) DEFAULT NULL,
  EXTERNALIZAR_FIRMA_EN_SIGA decimal(10,0) DEFAULT NULL,
  EXTERNALIZAR_FIRMA_EN_CCOO decimal(10,0) DEFAULT NULL,
  EXTERNALIZAR_FIRMA_EN_LOYS decimal(10,0) DEFAULT NULL,
  USUARIO_ASESOR varchar(255) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `datos_usuario_bkp_prod`
--

DROP TABLE IF EXISTS datos_usuario_bkp_prod;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE datos_usuario_bkp_prod (
  ID_DATO_USUARIO decimal(10,0) DEFAULT NULL,
  MAIL varchar(255) DEFAULT NULL,
  OCUPACION varchar(255) DEFAULT NULL,
  USER_ varchar(255) DEFAULT NULL,
  ...
  EXTERNALIZAR_FIRMA_EN_LOYS decimal(10,0) DEFAULT NULL,
  USUARIO_ASESOR varchar(255) DEFAULT NULL,
  USERSYNCH datetime DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `datos_usuario_hist`
--

DROP TABLE IF EXISTS datos_usuario_hist;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE datos_usuario_hist (
  ID_DATO_USUARIO decimal(10,0) DEFAULT NULL,
  MAIL varchar(255) DEFAULT NULL,
  OCUPACION varchar(255) DEFAULT NULL,
  USUARIO varchar(255) DEFAULT NULL,
  ...
  EXTERNALIZAR_FIRMA_EN_LOYS decimal(10,0) DEFAULT NULL,
  USUARIO_ASESOR varchar(255) DEFAULT NULL,
  NOTIFICAR_SOLICITUD_PF char(1) DEFAULT NULL,
  CARGO decimal(10,0) DEFAULT NULL,
  REVISION decimal(10,0) DEFAULT NULL,
  TIPO_REVISION int(11) DEFAULT NULL,
  CAMBIAR_MESA char(1) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `datos_usuario_synch`
--

DROP TABLE IF EXISTS datos_usuario_synch;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE datos_usuario_synch (
  ID_DATO_USUARIO decimal(12,0) DEFAULT NULL,
  USUARIO varchar(255) DEFAULT NULL,
  USERSYNCH datetime DEFAULT NULL,
  APE_Y_NOM varchar(2000) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `datosusuariobean`
--

DROP TABLE IF EXISTS datosusuariobean;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE datosusuariobean (
  ID_DATO_USUARIO decimal(10,0) DEFAULT NULL,
  MAIL varchar(255) DEFAULT NULL,
  OCUPACION varchar(255) DEFAULT NULL,
  USER_ varchar(255) DEFAULT NULL
...
CREATE TABLE destinatario (
  ID_DESTINATARIO decimal(10,0) DEFAULT NULL,
  DESTINO varchar(255) DEFAULT NULL,
  ID_COMUNICACIONOFICIALBEAN decimal(10,0) DEFAULT NULL,
  IDX decimal(10,0) DEFAULT NULL,
  MODALIDAD varchar(255) DEFAULT NULL,
  NOMBREFORMATEADO varchar(4000) DEFAULT NULL,
  CODIGO_REPARTICION varchar(255) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `destinatario_agrupado`
--

DROP TABLE IF EXISTS destinatario_agrupado;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE destinatario_agrupado (
  ID_DEST_AGRUP decimal(15,0) DEFAULT NULL,
  DESTINATARIO_AGRUPADO varchar(4000) DEFAULT NULL,
  INDICE decimal(10,0) DEFAULT NULL,
  ID_COMUNICACIONOFICIALBEAN decimal(15,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `periodo_licencia`
--

DROP TABLE IF EXISTS periodo_licencia;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE periodo_licencia (
  ID_PERIODO_LICENCIA int(10) NOT NULL,
  FECHA_HORA_DESDE datetime DEFAULT NULL,
  FECHA_HORA_HASTA datetime DEFAULT NULL,
  APODERADO varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `proceso_tomado`
--

DROP TABLE IF EXISTS proceso_tomado;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE proceso_tomado (
  ID_PROCESO_TOMADO decimal(10,0) DEFAULT NULL,
  USUARIO varchar(255) DEFAULT NULL,
  ID_PROCESO varchar(255) DEFAULT NULL,
  ACCION varchar(255) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `property_configuration_audi`
--

DROP TABLE IF EXISTS property_configuration_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE property_configuration_audi (
  ESQUEMA varchar(1024) DEFAULT NULL,
  CLAVE_OLD varchar(1024) DEFAULT NULL,
  VALOR_OLD varchar(1024) DEFAULT NULL,
  CONFIGURACION_OLD varchar(1024) DEFAULT NULL,
  CLAVE_NEW varchar(1024) DEFAULT NULL,
  VALOR_NEW varchar(1024) DEFAULT NULL,
  CONFIGURACION_NEW varchar(1024) DEFAULT NULL,
  FECHA datetime DEFAULT NULL,
  USUARIO varchar(1024) DEFAULT NULL,
  MAQUINA varchar(1024) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE revinfo (
  REV int(10) NOT NULL,
  REVTSTMP decimal(24,0) DEFAULT NULL,
  PRIMARY KEY (REV)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE usuario_logueado (
  ID_USUARIO_LOGUEADO decimal(10,0) DEFAULT NULL,
  USUARIO varchar(255) DEFAULT NULL,
  ID_SESION varchar(255) DEFAULT NULL,
  CODIGO_CARATULA varchar(255) DEFAULT NULL,
  ESTADO varchar(255) DEFAULT NULL,
  CODIGO_CARATULA_BEAN varchar(255) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `vista_comunicaciones_oficiales`
--

DROP TABLE IF EXISTS vista_comunicaciones_oficiales;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE vista_comunicaciones_oficiales (
  ID_COMUNICACIONES_OFICIALES_AU decimal(10,0) DEFAULT NULL,
  CODIGO_CARATULA varchar(255) DEFAULT NULL,
  ID_COMUNICACIONOFICIAL decimal(10,0) DEFAULT NULL,
  ID_VISTACOMUNICACIONOFICIAL decimal(10,0) DEFAULT NULL,
  USUARIO_FROM varchar(255) DEFAULT NULL,
  USUARIO_TO varchar(255) DEFAULT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
  ACCION varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `vistacomesaentradainbox`
--

DROP TABLE IF EXISTS vistacomesaentradainbox;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE vistacomesaentradainbox (
  ID_VISTACOMESAENTRADAINBOX decimal(10,0) DEFAULT NULL,
  ESTADO varchar(255) DEFAULT NULL,
  FECHA datetime DEFAULT NULL,
  ID_SECTOR_INTERNO decimal(10,0) DEFAULT NULL,
  NUMERO_COPIA decimal(10,0) DEFAULT NULL,
  CODIGO_COPIA_CARATULA varchar(255) DEFAULT NULL,
  ID_DESTINATARIO decimal(10,0) DEFAULT NULL,
  USER_NAME_TAKEN_MSG varchar(255) DEFAULT NULL,
  ID_COMUNICACIONOFICIAL decimal(10,0) DEFAULT NULL,
  NOMBRE_SECTOR_INTERNO varchar(255) DEFAULT NULL,
  NOMBRE_REPARTICION varchar(255) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `vistacomunicacionoficialinbox`
--

DROP TABLE IF EXISTS vistacomunicacionoficialinbox;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE vistacomunicacionoficialinbox (
  ID_VISTACOMUNICACIONOFICIALINB decimal(10,0) DEFAULT NULL,
  ESTADO varchar(255) DEFAULT NULL,
  FECHAAPERTURA datetime DEFAULT NULL,
  USERNAME varchar(255) DEFAULT NULL,
  EN_PROCESO_DE_RESPUESTA varchar(255) DEFAULT NULL,
  ID_COMUNICACIONOFICIALBEAN decimal(10,0) DEFAULT NULL,
  ESTADO_ABM varchar(255) DEFAULT NULL,
  DESTINATARIO_ORIGINAL varchar(255) DEFAULT NULL,
  REENVIO_X_LICENCIA varchar(1) DEFAULT NULL,
  FECHAOPERACION datetime DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2017-08-30 10:24:48
...
CREATE TABLE tad_documento (
  ...
  ID_TRANSACCION int(19) DEFAULT NULL,
...
CREATE TABLE tad_expediente_base (
  ...
  PRIMARY KEY (ID),
  KEY FK_tad_expediente_base_estado_tramite (ID_ESTADO_TRAMITE),
  CONSTRAINT FK_tad_expediente_base_estado_tramite FOREIGN KEY (ID_ESTADO_TRAMITE) REFERENCES estado_tramite (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tad_expediente_documento (
  ...
  KEY FK_tad_expediente_documento_tad_expediente_base (ID_EXPEDIENTE),
  KEY FK_tad_expediente_documento_tad_documento (ID_DOCUMENTO),
  CONSTRAINT FK_tad_expediente_documento_tad_documento FOREIGN KEY (ID_DOCUMENTO) REFERENCES tad_documento (ID),
  CONSTRAINT FK_tad_expediente_documento_tad_expediente_base FOREIGN KEY (ID_EXPEDIENTE) REFERENCES tad_expediente_base (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tad_notificacion (
  ...
  ID_PERSONA double DEFAULT NULL,
  PRIMARY KEY (ID),
  KEY FK_tad_notificacion_tad_expediente_base (ID_EXPEDIENTE_BASE),
  CONSTRAINT FK_tad_notificacion_tad_expediente_base FOREIGN KEY (ID_EXPEDIENTE_BASE) REFERENCES tad_expediente_base (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tad_tarea (
  ...
  PRIMARY KEY (ID),
  KEY FK_tad_tarea_estado_tarea (ID_ESTADO),
  CONSTRAINT FK_tad_tarea_estado_tarea FOREIGN KEY (ID_ESTADO) REFERENCES estado_tarea (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tad_tipo_documento (
  ...
  ID_TIPADO_DOCUMENTO int(11) NOT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
  FECHA_MODIFICACION datetime DEFAULT NULL,
  ESTADO tinyint(1) DEFAULT NULL,
  ...
  PRIMARY KEY (ID),
  KEY FK_tad_tipo_documento_tad_tipado_documento (ID_TIPADO_DOCUMENTO),
  CONSTRAINT FK_tad_tipo_documento_tad_tipado_documento FOREIGN KEY (ID_TIPADO_DOCUMENTO) REFERENCES tad_tipado_documento (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-08-30 10:24:49
...
CREATE TABLE hibernate_unique_key (
  NEXT_HI decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sade_actuacion`
--

DROP TABLE IF EXISTS sade_actuacion;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_actuacion (
  ID_ACTUACION int(10) NOT NULL,
  CODIGO_ACTUACION varchar(5) NOT NULL,
  NOMBRE_ACTUACION varchar(30) NOT NULL,
  VIGENCIA_DESDE datetime NOT NULL,
...
--
-- Table structure for table `sade_actuacion_audi`
--

DROP TABLE IF EXISTS sade_actuacion_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_actuacion_audi (
  ID_ACTUACION_AUDI int(11) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  CODIGO_ACTUACION varchar(5) NOT NULL,
  NOMBRE_ACTUACION varchar(30) NOT NULL,
...
--
-- Table structure for table `sade_actuaciones_deshabilitada`
--

DROP TABLE IF EXISTS sade_actuaciones_deshabilitada;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_actuaciones_deshabilitada (
  ID_SECTOR_INTERNO decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  ACTUACIONDESHABILITADA_INDEX decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_admin_reparticion`
--

DROP TABLE IF EXISTS sade_admin_reparticion;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_admin_reparticion (
  ID_ADMIN_REPARTICION decimal(10,0) NOT NULL,
  ID_REPARTICION decimal(10,0) NOT NULL,
  NOMBRE_USUARIO varchar(30) NOT NULL
);
...
--
-- Table structure for table `sade_admin_reparticion_hist`
--

DROP TABLE IF EXISTS sade_admin_reparticion_hist;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_admin_reparticion_hist (
  ID_ADMIN_REPARTICION decimal(10,0) NOT NULL,
  ID_REPARTICION decimal(10,0) NOT NULL,
  NOMBRE_USUARIO varchar(30) NOT NULL,
  REVISION decimal(10,0) NOT NULL,
...
--
-- Table structure for table `sade_agrupacion_sector_mesa`
--

DROP TABLE IF EXISTS sade_agrupacion_sector_mesa;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_agrupacion_sector_mesa (
  ID_AGRUPACION_SECTOR_MESA decimal(10,0) NOT NULL,
  NOMBRE varchar(255) NOT NULL,
  ID_SECTOR_PRINCIPAL decimal(10,0) DEFAULT NULL,
  ESTADO char(1) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_anio_numero_sec_work`
--

DROP TABLE IF EXISTS sade_anio_numero_sec_work;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_anio_numero_sec_work (
  ID decimal(10,0) NOT NULL,
  CARATULA varchar(30) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
  SECUENCIA decimal(10,0) DEFAULT NULL,
  FECHA_CREACION datetime NOT NULL,
...
--
-- Table structure for table `sade_anio_numero_sec_work_res`
--

DROP TABLE IF EXISTS sade_anio_numero_sec_work_res;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_anio_numero_sec_work_res (
  ID decimal(10,0) NOT NULL,
  CARATULA varchar(30) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
...
--
-- Table structure for table `sade_archivos_de_trabajo`
--

DROP TABLE IF EXISTS sade_archivos_de_trabajo;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_archivos_de_trabajo (
  ID_ARCHIVO decimal(25,0) NOT NULL,
  NOMBRE_ARCHIVO varchar(100) NOT NULL,
  DEFINITIVO varchar(1) NOT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_auditoria`
--

DROP TABLE IF EXISTS sade_auditoria;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_auditoria (
  ID_AUDITORIA decimal(10,0) NOT NULL,
  USER_ID varchar(255) NOT NULL,
  FECHA_CREACION datetime NOT NULL,
  ID_TIPO_TAREA decimal(10,0) NOT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_auditoria_tarea`
--

DROP TABLE IF EXISTS sade_auditoria_tarea;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_auditoria_tarea (
  ID_TIPO_TAREA decimal(10,0) NOT NULL,
...
--
-- Table structure for table `sade_calle`
--

DROP TABLE IF EXISTS sade_calle;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_calle (
  ID_CALLE decimal(10,0) NOT NULL,
  CODIGO_CALLE double NOT NULL,
  CODIGO_POSTAL varchar(10) NOT NULL,
  NOMBRE_CALLE varchar(30) NOT NULL,
  ALTURA_DESDE double NOT NULL,
  ALTURA_HASTA double NOT NULL,
  ID_CALLE_ANTERIOR decimal(10,0) NOT NULL,
  VIGENCIA_DESDE datetime NOT NULL,
  VIGENCIA_HASTA datetime NOT NULL,
  VERSION decimal(10,0) NOT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
...
--
-- Table structure for table `sade_caratula_secuencia`
--

DROP TABLE IF EXISTS sade_caratula_secuencia;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_caratula_secuencia (
  ID_CARATULA_SECUENCIA decimal(10,0) NOT NULL,
  ANIO decimal(10,0) NOT NULL,
  NUMERO_SECUENCIA decimal(10,0) NOT NULL,
  VERSION decimal(10,0) NOT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_contrato`
--

DROP TABLE IF EXISTS sade_contrato;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_contrato (
  ID_CONTRATO decimal(10,0) NOT NULL,
  DESCRIPCION varchar(60) NOT NULL,
  FECHA_SUSCRIPCION datetime NOT NULL,
  FECHA_INICIO datetime NOT NULL,
  FECHA_FIN datetime NOT NULL,
  CUIT varchar(15) NOT NULL,
  ID_CONTRATO_CARATULA decimal(10,0) NOT NULL,
  CONTRATO_INDEX decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_creacion_pase_audi`
--

DROP TABLE IF EXISTS sade_creacion_pase_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_creacion_pase_audi (
  ID_PASE decimal(10,0) NOT NULL,
  ID_EXPEDIENTE_PPAL decimal(10,0) NOT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
...
--
-- Table structure for table `sade_del_expediente`
--

DROP TABLE IF EXISTS sade_del_expediente;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_del_expediente (
  ID_EXPEDIENTE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
  ID_REPARTICION_ACTUACION decimal(10,0) NOT NULL,
  ID_SECUENCIA decimal(10,0) DEFAULT NULL,
  TIENE_PASE char(2) DEFAULT NULL,
  TIENE_PASE_DETALLE char(2) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_del_expediente_rep_v2`
--

DROP TABLE IF EXISTS sade_del_expediente_rep_v2;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_del_expediente_rep_v2 (
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
  ID_REPARTICION_ACTUACION decimal(10,0) NOT NULL,
  ID_SECUENCIA decimal(10,0) NOT NULL,
  CANT_REG decimal(10,0) NOT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_dup_expediente_audi_bkp`
--

DROP TABLE IF EXISTS sade_dup_expediente_audi_bkp;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_dup_expediente_audi_bkp (
  ID_EXPEDIENTE_AUDI decimal(10,0) NOT NULL,
  ID_EXPEDIENTE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  CODIGO_EXPEDIENTE varchar(100) NOT NULL,
  FECHA_ACTUACION datetime NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
  ID_REPARTICION_ACTUACION decimal(10,0) NOT NULL,
  ID_REPARTICION_USUARIO decimal(10,0) DEFAULT NULL,
  ID_SECUENCIA decimal(10,0) DEFAULT NULL,
  ID_TIPO_DOCUMENTO decimal(10,0) DEFAULT NULL,
  NRO_DOCUMENTO varchar(20) DEFAULT NULL,
  APELLIDO_RAZON varchar(60) DEFAULT NULL,
  ID_TIPO_ACTUACION_INICIA decimal(10,0) DEFAULT NULL,
  ANIO_ACTUACION_INICIA decimal(10,0) DEFAULT NULL,
  NUMERO_ACTUACION_INICIA decimal(10,0) DEFAULT NULL,
  ID_REPARTICION_ACTUACION_INICI decimal(10,0) DEFAULT NULL,
  NUMERO_SECUENCIA_INICIA decimal(10,0) DEFAULT NULL,
  ID_REPARTICION_SOLICITANTE decimal(10,0) DEFAULT NULL,
  ID_REPARTICION_JUD decimal(10,0) DEFAULT NULL,
  ACT_EXTRAMUNICIPAL varchar(35) DEFAULT NULL,
  CUERPOS_ANEXOS varchar(255) DEFAULT NULL,
  ID_CODIGO_TRAMITE decimal(10,0) DEFAULT NULL,
  DESCRIPCION_TRATA varchar(750) DEFAULT NULL,
  ISSIB varchar(9) DEFAULT NULL,
  DOMINIO varchar(10) DEFAULT NULL,
  DENUNCIA varchar(15) DEFAULT NULL,
  ID_REPARTICION_ORIGEN decimal(10,0) DEFAULT NULL,
  ID_REPARTICION_DESTINO decimal(10,0) DEFAULT NULL,
  ID_SECTOR_ORIGEN decimal(10,0) DEFAULT NULL,
  ID_SECTOR_DESTINO decimal(10,0) DEFAULT NULL,
  FOJAS decimal(10,0) NOT NULL,
  CONS_ID_CALLE_EXT decimal(10,0) DEFAULT NULL,
  CONS_ID_CALLE1_EXT decimal(10,0) DEFAULT NULL,
  CONS_ID_CALLE2_EXT decimal(10,0) DEFAULT NULL,
  CONS_ID_ESQUIN_EXT decimal(10,0) DEFAULT NULL,
  CONS_ALTURA varchar(10) DEFAULT NULL,
  CONS_NUMERO varchar(10) DEFAULT NULL,
  CONS_EDIFICIO varchar(10) DEFAULT NULL,
  CONS_PISO varchar(10) DEFAULT NULL,
  CONS_DEPARTAMENTO varchar(10) DEFAULT NULL,
  CONS_UNIDAD_FUNCIONAL varchar(10) DEFAULT NULL,
  CONS_LOCAL varchar(35) DEFAULT NULL,
  CONS_PARTIDA varchar(35) DEFAULT NULL,
  CONS_CATASTRAL varchar(35) DEFAULT NULL,
  OBSERVACIONES varchar(250) DEFAULT NULL,
  CONTROLADO varchar(1) DEFAULT NULL,
  VERSION decimal(10,0) DEFAULT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
  USUARIO_CREACION varchar(30) DEFAULT NULL,
  FECHA_MODIFICACION datetime DEFAULT NULL,
  USUARIO_MODIFICACION varchar(30) DEFAULT NULL,
  CARATULADO varchar(1) NOT NULL,
  ...
  ANIO_SIGAF decimal(10,0) DEFAULT NULL,
  ORDEN_PAGO varchar(10) DEFAULT NULL,
  RECIBO_SUELTO char(1) DEFAULT NULL,
  FAC_TIPO char(2) DEFAULT NULL,
  FAC_ANIO decimal(10,0) DEFAULT NULL,
  FAC_NRO double DEFAULT NULL,
  FAC_IMPORTE double DEFAULT NULL,
  NRO_SIGAF decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_dup_expediente_bkp`
--

DROP TABLE IF EXISTS sade_dup_expediente_bkp;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_dup_expediente_bkp (
  ID_EXPEDIENTE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  CODIGO_EXPEDIENTE varchar(100) NOT NULL,
  FECHA_ACTUACION datetime NOT NULL,
...
--
-- Table structure for table `sade_dup_pase_audi_bkp`
--

DROP TABLE IF EXISTS sade_dup_pase_audi_bkp;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_dup_pase_audi_bkp (
  ID_PASE_AUDI decimal(10,0) NOT NULL,
  ID_PASE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
  ...
  FECHA_INICIO datetime NOT NULL,
  FECHA_FIN datetime DEFAULT NULL,
  ACT_PPAL varchar(100) NOT NULL,
  ID_EXPEDIENTE_PPAL decimal(10,0) NOT NULL,
  ID_PERMANENCIA decimal(10,0) DEFAULT NULL,
  ID_REPART_ORIGEN decimal(10,0) DEFAULT NULL,
  ID_REPART_DESTINO decimal(10,0) DEFAULT NULL,
  ID_SECTOR_ORIGEN decimal(10,0) DEFAULT NULL,
  ID_SECTOR_DESTINO decimal(10,0) DEFAULT NULL,
  FOJAS decimal(10,0) NOT NULL,
  RECIBO_SUELTO varchar(1) DEFAULT NULL,
  NUMER_REMITO decimal(10,0) DEFAULT NULL,
  ESTADO_PASE varchar(1) DEFAULT NULL,
  ACCION varchar(1) DEFAULT NULL,
  VERSION decimal(10,0) DEFAULT NULL,
  FECHA_A datetime DEFAULT NULL,
  FUNCION_A varchar(1) NOT NULL,
  USUARIO_A varchar(20) NOT NULL,
  ID_SECTOR_INTERNO_A decimal(10,0) NOT NULL,
  ACTUA_CARATULACION varchar(1) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_dup_pase_bkp`
--

DROP TABLE IF EXISTS sade_dup_pase_bkp;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_dup_pase_bkp (
  ID_PASE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
  ...
  FECHA_ACTUACION datetime DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_dup_pase_detalle_audi_bkp`
--

DROP TABLE IF EXISTS sade_dup_pase_detalle_audi_bkp;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_dup_pase_detalle_audi_bkp (
  ID_PASE_DETALLE_AUDI decimal(10,0) NOT NULL,
  ID_PASE_AUDI decimal(10,0) NOT NULL,
  ID_PASE_DETALLE decimal(10,0) NOT NULL,
  ID_PASE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
  ...
  ID_SECUENCIA decimal(10,0) DEFAULT NULL,
  FECHA_INICIO datetime NOT NULL,
  ACT_INCORPORADA varchar(100) NOT NULL,
  COD_INCORPORADO decimal(10,0) NOT NULL,
  FOJAS decimal(10,0) NOT NULL,
  COMP_ANO decimal(10,0) DEFAULT NULL,
  COMP_NRO double DEFAULT NULL,
  COMP_IMP double DEFAULT NULL,
  CUERPOS_ANEXOS varchar(255) DEFAULT NULL,
  ORDEN_PAGO varchar(255) DEFAULT NULL,
  COMP_TIPO varchar(255) DEFAULT NULL,
  TRATA longtext,
  EJECUTIVA varchar(255) DEFAULT NULL,
  ZANIO decimal(10,0) DEFAULT NULL,
  ZLEGAJO decimal(10,0) DEFAULT NULL,
  ZESTANTE decimal(10,0) DEFAULT NULL,
  OBSERVACIONES1 varchar(255) DEFAULT NULL,
  VERSION decimal(10,0) NOT NULL,
  ESTADO_PASE_DETALLE varchar(1) DEFAULT NULL,
  ID_EXPEDIENTE_INC decimal(10,0) DEFAULT NULL,
  FECHA_A datetime DEFAULT NULL,
  FUNCION_A varchar(1) NOT NULL,
  USUARIO_A varchar(20) NOT NULL,
  ID_SECTOR_INTERNO_A decimal(10,0) NOT NULL,
  PAQ_ACTUA_ANTERIOR varchar(1) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_dup_pase_detalle_bkp`
--

DROP TABLE IF EXISTS sade_dup_pase_detalle_bkp;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_dup_pase_detalle_bkp (
  ID_PASE decimal(10,0) NOT NULL,
  ID_PASE_DETALLE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  ...
  ZLEGAJO decimal(10,0) DEFAULT NULL,
  ZESTANTE decimal(10,0) DEFAULT NULL,
  OBSERVACIONES1 varchar(250) DEFAULT NULL,
  VERSION decimal(10,0) DEFAULT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
  USUARIO_CREACION varchar(30) DEFAULT NULL,
  FECHA_MODIFICACION datetime DEFAULT NULL,
...
--
-- Table structure for table `sade_estructura`
--

DROP TABLE IF EXISTS sade_estructura;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_estructura (
  ID_ESTRUCTURA int(10) NOT NULL,
  CODIGO_ESTRUCTURA decimal(10,0) NOT NULL,
  NOMBRE_ESTRUCTURA varchar(100) NOT NULL,
  VIGENCIA_DESDE datetime NOT NULL,
...
--
-- Table structure for table `sade_expediente`
--

DROP TABLE IF EXISTS sade_expediente;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_expediente (
  ID_EXPEDIENTE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  CODIGO_EXPEDIENTE varchar(100) NOT NULL,
  FECHA_ACTUACION datetime NOT NULL,
  ...
  ID_REFERIDO_A decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_expediente_audi`
--

DROP TABLE IF EXISTS sade_expediente_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_expediente_audi (
  ID_EXPEDIENTE_AUDI decimal(10,0) NOT NULL,
  ID_EXPEDIENTE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  CODIGO_EXPEDIENTE varchar(100) NOT NULL,
...
--
-- Table structure for table `sade_expediente_audi_carga_wor`
--

DROP TABLE IF EXISTS sade_expediente_audi_carga_wor;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_expediente_audi_carga_wor (
  FECHA_INICIO datetime DEFAULT NULL,
  FECHA_UPD datetime DEFAULT NULL,
  CANT_LEIDO decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_expediente_audi_mig`
--

DROP TABLE IF EXISTS sade_expediente_audi_mig;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_expediente_audi_mig (
  ID_EXPEDIENTE_AUDI decimal(10,0) NOT NULL,
  ID_EXPEDIENTE decimal(10,0) DEFAULT NULL,
  ID_ACTUACION decimal(10,0) DEFAULT NULL,
  CODIGO_EXPEDIENTE varchar(100) NOT NULL,
  FECHA_ACTUACION datetime DEFAULT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
  ID_REPARTICION_ACTUACION decimal(10,0) DEFAULT NULL,
  ID_REPARTICION_USUARIO decimal(10,0) DEFAULT NULL,
  ID_SECUENCIA decimal(10,0) DEFAULT NULL,
  ID_TIPO_DOCUMENTO decimal(10,0) DEFAULT NULL,
  NRO_DOCUMENTO varchar(20) DEFAULT NULL,
  ...
  ID_SECTOR_ORIGEN decimal(10,0) DEFAULT NULL,
  ID_SECTOR_DESTINO decimal(10,0) DEFAULT NULL,
  FOJAS decimal(10,0) DEFAULT NULL,
  CONS_ID_CALLE_EXT decimal(10,0) DEFAULT NULL,
  CONS_ID_CALLE1_EXT decimal(10,0) DEFAULT NULL,
  CONS_ID_CALLE2_EXT decimal(10,0) DEFAULT NULL,
  CONS_ID_ESQUIN_EXT decimal(10,0) DEFAULT NULL,
  ...
  FECHA_MODIFICACION datetime DEFAULT NULL,
  USUARIO_MODIFICACION varchar(30) DEFAULT NULL,
  CARATULADO varchar(1) DEFAULT NULL,
  ACCION varchar(1) DEFAULT NULL,
  ESTADO varchar(1) DEFAULT NULL,
  FECHA_A datetime NOT NULL,
  FUNCION_A varchar(1) NOT NULL,
...
--
-- Table structure for table `sade_expediente_ce`
--

DROP TABLE IF EXISTS sade_expediente_ce;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_expediente_ce (
  ID_EXPEDIENTE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  CODIGO_EXPEDIENTE varchar(100) NOT NULL,
  FECHA_ACTUACION datetime NOT NULL,
  ...
  FAC_NRO double DEFAULT NULL,
  FAC_IMPORTE double DEFAULT NULL,
  W_PROCESO char(10) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_expediente_upd_pase_inc_w`
--

DROP TABLE IF EXISTS sade_expediente_upd_pase_inc_w;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_expediente_upd_pase_inc_w (
  FECHA_INICIO datetime DEFAULT NULL,
  FECHA_UPD datetime DEFAULT NULL,
  CANT_LEIDO decimal(10,0) DEFAULT NULL,
  ID_EXPEDIENTE_ULTIMO decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_expediente_upd_pase_work`
--

DROP TABLE IF EXISTS sade_expediente_upd_pase_work;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_expediente_upd_pase_work (
  FECHA_INICIO datetime DEFAULT NULL,
  FECHA_UPD datetime DEFAULT NULL,
  CANT_LEIDO decimal(10,0) DEFAULT NULL,
  ID_EXPEDIENTE_ULTIMO decimal(10,0) DEFAULT NULL
...
--
-- Table structure for table `sade_expediente_upd_work`
--

DROP TABLE IF EXISTS sade_expediente_upd_work;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_expediente_upd_work (
  FECHA_INICIO datetime DEFAULT NULL,
  FECHA_UPD datetime DEFAULT NULL,
  CANT_LEIDO decimal(10,0) DEFAULT NULL,
  ID_EXPEDIENTE decimal(10,0) DEFAULT NULL
...
CREATE TABLE sade_extracto (
  ID_EXTRACTO decimal(10,0) NOT NULL,
...
--
-- Table structure for table `sade_extracto_deshabilitado_po`
--

DROP TABLE IF EXISTS sade_extracto_deshabilitado_po;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_extracto_deshabilitado_po (
  ID_EXTRACTO decimal(10,0) NOT NULL,
  ID_REPARTICION decimal(10,0) NOT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sade_jurisdiccion`
--

DROP TABLE IF EXISTS sade_jurisdiccion;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_jurisdiccion (
  ID int(10) NOT NULL,
  DESCRIPCION varchar(500) NOT NULL,
  PRIMARY KEY (ID)
);
...
--
-- Table structure for table `sade_mig_bitacora_track`
--

DROP TABLE IF EXISTS sade_mig_bitacora_track;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_mig_bitacora_track (
  TOKEN varchar(4000) DEFAULT NULL,
  IDORIGEN varchar(4000) DEFAULT NULL,
  IDDESTINO varchar(4000) DEFAULT NULL,
  ESSECTOR varchar(4000) DEFAULT NULL,
  ESREPARTICION varchar(4000) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_migracion_numerador`
--

DROP TABLE IF EXISTS sade_migracion_numerador;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_migracion_numerador (
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
  ID_SECUENCIA decimal(10,0) DEFAULT NULL,
  ID_REPARTICION_ACTUACION varchar(20) NOT NULL,
  ID_REPARTICION_USUARIO varchar(20) DEFAULT NULL,
  FECHA_CREACION datetime NOT NULL,
...
--
-- Table structure for table `sade_modificacion_pase_audi`
--

DROP TABLE IF EXISTS sade_modificacion_pase_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_modificacion_pase_audi (
  ID_PASE decimal(10,0) NOT NULL,
  ID_EXPEDIENTE_PPAL decimal(10,0) NOT NULL,
  FECHA_MODIFICACION datetime DEFAULT NULL,
...
--
-- Table structure for table `sade_param_audit`
--

DROP TABLE IF EXISTS sade_param_audit;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_param_audit (
  ID_PARAMETROS decimal(10,0) NOT NULL,
  CLAVE varchar(255) NOT NULL,
  VALOR varchar(255) NOT NULL,
  ID_AUDITORIA decimal(10,0) DEFAULT NULL,
  PARAMETROS_AUDITORIA_INDEX decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_pase`
--

DROP TABLE IF EXISTS sade_pase;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_pase (
  ID_PASE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
...
--
-- Table structure for table `sade_pase_archivo_de_trabajo`
--

DROP TABLE IF EXISTS sade_pase_archivo_de_trabajo;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_pase_archivo_de_trabajo (
  ID_PASE_ARCHIVO decimal(25,0) NOT NULL,
  NOMBRE_ARCHIVO varchar(100) NOT NULL,
  DEFINITIVO varchar(1) NOT NULL,
  FECHA_MODIFICACION datetime NOT NULL,
  ID_PASE_DETALLE decimal(25,0) NOT NULL,
...
--
-- Table structure for table `sade_pase_audi`
--

DROP TABLE IF EXISTS sade_pase_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_pase_audi (
  ID_PASE_AUDI decimal(10,0) NOT NULL,
  ID_PASE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  ...
  FECHA_A datetime DEFAULT NULL,
  FUNCION_A varchar(1) NOT NULL,
  USUARIO_A varchar(400) NOT NULL,
  ID_SECTOR_INTERNO_A decimal(10,0) NOT NULL,
  ACTUA_CARATULACION varchar(1) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sade_pase_audi_dif_work`
--

DROP TABLE IF EXISTS sade_pase_audi_dif_work;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_pase_audi_dif_work (
  P_ID_PASE_AUDI decimal(10,0) NOT NULL,
  P_ID_PASE decimal(10,0) NOT NULL,
  P_ID_ACTUACION decimal(10,0) NOT NULL,
  P_ANIO_ACTUACION decimal(10,0) NOT NULL,
  P_NUMERO_ACTUACION decimal(10,0) NOT NULL,
  P_ID_REPARTICION_ACTUACION decimal(10,0) NOT NULL,
  P_ID_REPARTICION_USUARIO decimal(10,0) DEFAULT NULL,
  P_ID_SECUENCIA decimal(10,0) DEFAULT NULL,
  P_FECHA_INICIO datetime NOT NULL,
  P_FECHA_FIN datetime DEFAULT NULL,
  P_ACT_PPAL varchar(100) NOT NULL,
  P_ID_EXPEDIENTE_PPAL decimal(10,0) NOT NULL,
  P_ID_PERMANENCIA decimal(10,0) DEFAULT NULL,
  P_ID_REPART_ORIGEN decimal(10,0) DEFAULT NULL,
  P_ID_REPART_DESTINO decimal(10,0) DEFAULT NULL,
  P_ID_SECTOR_ORIGEN decimal(10,0) DEFAULT NULL,
  P_ID_SECTOR_DESTINO decimal(10,0) DEFAULT NULL,
  P_FOJAS decimal(10,0) NOT NULL,
  P_RECIBO_SUELTO varchar(1) DEFAULT NULL,
  P_NUMER_REMITO decimal(10,0) DEFAULT NULL,
  P_ESTADO_PASE varchar(1) DEFAULT NULL,
  P_ACCION varchar(1) DEFAULT NULL,
  P_VERSION decimal(10,0) DEFAULT NULL,
  P_FECHA_CREACION datetime DEFAULT NULL,
  P_USUARIO_CREACION varchar(30) DEFAULT NULL,
  P_FECHA_MODIFICACION datetime DEFAULT NULL,
  P_USUARIO_MODIFICACION varchar(30) DEFAULT NULL,
  P_FECHA_ACTUACION datetime DEFAULT NULL,
  P_FECHA_A datetime NOT NULL,
  P_FUNCION_A varchar(1) NOT NULL,
  P_USUARIO_A varchar(20) NOT NULL,
  P_ID_SECTOR_INTERNO_A decimal(10,0) NOT NULL,
  D_ID_PASE_AUDI decimal(10,0) NOT NULL,
  D_ID_PASE_DETALLE decimal(10,0) NOT NULL,
  D_ID_PASE decimal(10,0) NOT NULL,
  D_ID_ACTUACION decimal(10,0) NOT NULL,
  D_ANIO_ACTUACION decimal(10,0) NOT NULL,
  D_NUMERO_ACTUACION decimal(10,0) NOT NULL,
  D_ID_REPARTICION_ACTUACION decimal(10,0) NOT NULL,
  D_ID_REPARTICION_USUARIO decimal(10,0) DEFAULT NULL,
  D_ID_SECUENCIA decimal(10,0) DEFAULT NULL,
  D_FECHA_INICIO datetime NOT NULL,
  D_ACT_INCORPORADA varchar(100) NOT NULL,
  D_COD_INCORPORADO decimal(10,0) NOT NULL,
  D_FOJAS decimal(10,0) NOT NULL,
  D_COMP_ANO decimal(10,0) DEFAULT NULL,
  D_COMP_NRO double DEFAULT NULL,
  D_COMP_IMP double DEFAULT NULL,
  D_CUERPOS_ANEXOS varchar(255) DEFAULT NULL,
  D_ORDEN_PAGO varchar(255) DEFAULT NULL,
  D_COMP_TIPO varchar(255) DEFAULT NULL,
  D_TRATA longtext,
  D_EJECUTIVA varchar(255) DEFAULT NULL,
  D_ZANIO decimal(10,0) DEFAULT NULL,
  D_ZLEGAJO decimal(10,0) DEFAULT NULL,
  D_ZESTANTE decimal(10,0) DEFAULT NULL,
  D_OBSERVACIONES1 varchar(250) DEFAULT NULL,
  D_VERSION decimal(10,0) DEFAULT NULL,
  D_ESTADO_PASE_DETALLE varchar(1) DEFAULT NULL,
  D_ID_EXPEDIENTE_INC decimal(10,0) DEFAULT NULL,
  D_FECHA_CREACION datetime DEFAULT NULL,
  D_USUARIO_CREACION varchar(30) DEFAULT NULL,
  D_FECHA_MODIFICACION datetime DEFAULT NULL,
  D_USUARIO_MODIFICACION varchar(30) DEFAULT NULL,
  D_PAQ_ACTUA_ANTERIOR varchar(1) DEFAULT NULL,
  D_FECHA_A datetime NOT NULL,
  D_FUNCION_A varchar(1) NOT NULL,
  D_USUARIO_A varchar(20) NOT NULL,
  D_ID_SECTOR_INTERNO_A decimal(10,0) NOT NULL,
  W_ORDEN varchar(1) DEFAULT NULL,
  W_ACT_PRINCIPAL varchar(100) NOT NULL,
  W_ACT_INCORPORADA varchar(100) NOT NULL,
  W_ID_REPART_ORIGEN decimal(10,0) DEFAULT NULL,
  W_ID_REPART_DESTINO decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_pase_audi_mig`
--

DROP TABLE IF EXISTS sade_pase_audi_mig;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_pase_audi_mig (
  ID_PASE_AUDI decimal(10,0) NOT NULL,
  ID_PASE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  ...
  ID_SECTOR_INTERNO_A decimal(10,0) NOT NULL,
  ACTUA_CARATULACION varchar(1) DEFAULT NULL,
  ID_RORIGEN_TMP decimal(10,0) DEFAULT NULL,
  ID_RDESTINO_TMP decimal(10,0) DEFAULT NULL,
  CODIGO_SECTOR_INTERNO varchar(9) DEFAULT NULL,
  TIPO_SECTOR char(1) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_pase_copia`
--

DROP TABLE IF EXISTS sade_pase_copia;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_pase_copia (
  ID_PASE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
  NUMERO_ACTUACION decimal(10,0) NOT NULL,
...
--
-- Table structure for table `sade_pase_detalle`
--

DROP TABLE IF EXISTS sade_pase_detalle;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_pase_detalle (
  ID_PASE decimal(10,0) NOT NULL,
  ID_PASE_DETALLE decimal(10,0) NOT NULL,
  ID_ACTUACION decimal(10,0) NOT NULL,
  ANIO_ACTUACION decimal(10,0) NOT NULL,
...
--
-- Table structure for table `sade_pase_detalle_audi`
--

DROP TABLE IF EXISTS sade_pase_detalle_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_pase_detalle_audi (
  ID_PASE_DETALLE_AUDI decimal(10,0) NOT NULL,
  ID_PASE_AUDI decimal(10,0) NOT NULL,
  ID_PASE_DETALLE decimal(10,0) NOT NULL,
  ID_PASE decimal(10,0) NOT NULL,
...
--
-- Table structure for table `sade_pase_upd_fecha_fin_work`
--

DROP TABLE IF EXISTS sade_pase_upd_fecha_fin_work;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_pase_upd_fecha_fin_work (
  FECHA_INICIO datetime DEFAULT NULL,
  FECHA_UPD datetime DEFAULT NULL,
  CANT_LEIDO decimal(10,0) DEFAULT NULL,
  ID_EXPEDIENTE_ULTIMO decimal(10,0) DEFAULT NULL
...
--
-- Table structure for table `sade_permanencia`
--

DROP TABLE IF EXISTS sade_permanencia;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_permanencia (
  ID_PERMANENCIA decimal(10,0) NOT NULL,
  CODIGO_PERMANENCIA varchar(2) NOT NULL,
  NOMBRE_PERMANENCIA varchar(40) NOT NULL,
  VIGENCIA_DESDE datetime NOT NULL,
  VIGENCIA_HASTA datetime NOT NULL,
  VERSION decimal(10,0) NOT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
  ...
  USUARIO_MODIFICACION varchar(30) DEFAULT NULL,
  ESTADO_REGISTRO varchar(1) DEFAULT NULL,
  DIAS_DE_PERMANENCIA decimal(10,0) DEFAULT NULL,
  ACTIVA_ARCHIVO varchar(1) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_remito`
--

DROP TABLE IF EXISTS sade_remito;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_remito (
  ID_REMITO decimal(10,0) NOT NULL,
  ID_REPAR_ORIGEN decimal(10,0) DEFAULT NULL,
  NUMERO_REMITO decimal(10,0) NOT NULL,
  FECHA_EMISI_REMITO datetime DEFAULT NULL,
  FECHA_RECEP_REMITO datetime DEFAULT NULL,
  ESTADO_REMITO varchar(1) DEFAULT NULL,
  ID_REPAR_DESTINO decimal(10,0) DEFAULT NULL,
  ID_SECTOR_INTERNO_ORIGEN decimal(10,0) DEFAULT NULL,
  ID_SECTOR_INTERNO_DESTINO decimal(10,0) DEFAULT NULL,
  VERSION decimal(10,0) NOT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
  USUARIO_CREACION varchar(30) DEFAULT NULL,
  FECHA_MODIFICACION datetime DEFAULT NULL,
...
--
-- Table structure for table `sade_remito_audi`
--

DROP TABLE IF EXISTS sade_remito_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_remito_audi (
  ID_REMITO_AUDI decimal(10,0) NOT NULL,
  NUMERO_REMITO decimal(10,0) NOT NULL,
  ID_REPAR_ORIGEN decimal(10,0) DEFAULT NULL,
  FECHA_EMISI_REMITO datetime DEFAULT NULL,
  FECHA_RECEP_REMITO datetime DEFAULT NULL,
  ...
  ID_SECTOR_INTERNO_ORIGEN decimal(10,0) DEFAULT NULL,
  ID_SECTOR_INTERNO_DESTINO decimal(10,0) DEFAULT NULL,
  ID_REPARTICION_A decimal(10,0) DEFAULT NULL,
  FECHA_A datetime NOT NULL,
  FUNCION_A varchar(1) NOT NULL,
  USUARIO_A varchar(30) NOT NULL,
  ID_SECTOR_INTERNO_A decimal(10,0) NOT NULL,
  ID_REMITO decimal(10,0) NOT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sade_remito_numeracion`
--

DROP TABLE IF EXISTS sade_remito_numeracion;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_remito_numeracion (
  ID_REMITO_NUMERACION decimal(10,0) NOT NULL,
  ANIO decimal(10,0) NOT NULL,
  NUMERO_REMITO decimal(10,0) NOT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
  USUARIO_CREACION varchar(30) DEFAULT NULL,
...
--
-- Table structure for table `sade_remito_secuencia`
--

DROP TABLE IF EXISTS sade_remito_secuencia;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_remito_secuencia (
  ID_REMITO_SECUENCIA decimal(10,0) NOT NULL,
  NRO_SECUENCIA decimal(10,0) NOT NULL,
  ANIO decimal(10,0) NOT NULL,
  VERSION decimal(10,0) NOT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sade_reparticion`
--

DROP TABLE IF EXISTS sade_reparticion;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_reparticion (
  ID_REPARTICION int(10) NOT NULL,
  CODIGO_REPARTICION varchar(100) NOT NULL,
  CODIGO_REPAR_INTER varchar(100) DEFAULT NULL,
  NOMBRE_REPARTICION varchar(120) NOT NULL,
...
--
-- Table structure for table `sade_reparticion_audi`
--

DROP TABLE IF EXISTS sade_reparticion_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_reparticion_audi (
  ID_REPARTICION_AUDI decimal(10,0) NOT NULL,
  ID_REPARTICION decimal(10,0) NOT NULL,
  CODIGO_REPARTICION varchar(100) NOT NULL,
  CODIGO_REPAR_INTER varchar(100) DEFAULT NULL,
  NOMBRE_REPARTICION varchar(120) NOT NULL,
  VIGENCIA_DESDE datetime NOT NULL,
  VIGENCIA_HASTA datetime NOT NULL,
  ID_CALLE_REPAR decimal(10,0) NOT NULL,
  NUMERO varchar(10) NOT NULL,
  PISO varchar(10) DEFAULT NULL,
  OFICINA varchar(10) DEFAULT NULL,
  TELEFONO varchar(30) DEFAULT NULL,
  FAX varchar(30) DEFAULT NULL,
  EMAIL varchar(30) DEFAULT NULL,
  ID_ESTRUCTURA decimal(10,0) NOT NULL,
  EN_RED varchar(1) DEFAULT NULL,
  SECTOR_MESA varchar(1) DEFAULT NULL,
  VERSION decimal(10,0) DEFAULT NULL,
  FECHA_A datetime DEFAULT NULL,
  FUNCION_A varchar(1) NOT NULL,
  USUARIO_A varchar(20) DEFAULT NULL,
  ID_SECTOR_INTERNO_A decimal(10,0) DEFAULT NULL,
  ES_DGTAL int(11) NOT NULL,
  REP_PADRE decimal(10,0) NOT NULL,
  ID_JURISDICCION int(11) DEFAULT NULL,
  MINISTERIO decimal(10,0) DEFAULT NULL,
  ADMINISTRADOR_PRESUPUESTO decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_reparticion_contaduria`
--

DROP TABLE IF EXISTS sade_reparticion_contaduria;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_reparticion_contaduria (
  ID_ decimal(10,0) NOT NULL,
  CODIGO_REPARTICION_PROPICIANTE varchar(9) NOT NULL,
  CODIGO_REPARTICION_CONTADURIA varchar(9) NOT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_reparticion_mig`
--

DROP TABLE IF EXISTS sade_reparticion_mig;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_reparticion_mig (
  ID_REPARTICION decimal(10,0) DEFAULT NULL,
  CODIGO_REPARTICION varchar(9) DEFAULT NULL,
  CODIGO_REPAR_INTER varchar(9) DEFAULT NULL,
  NOMBRE_REPARTICION varchar(120) DEFAULT NULL,
  VIGENCIA_DESDE datetime DEFAULT NULL,
  VIGENCIA_HASTA datetime DEFAULT NULL,
  ID_CALLE_REPAR decimal(10,0) DEFAULT NULL,
  NUMERO varchar(10) DEFAULT NULL,
  PISO varchar(10) DEFAULT NULL,
  OFICINA varchar(10) DEFAULT NULL,
  TELEFONO varchar(30) DEFAULT NULL,
  FAX varchar(30) DEFAULT NULL,
  EMAIL varchar(30) DEFAULT NULL,
  ID_ESTRUCTURA decimal(10,0) DEFAULT NULL,
  EN_RED varchar(1) DEFAULT NULL,
  SECTOR_MESA varchar(1) DEFAULT NULL,
  VERSION decimal(10,0) DEFAULT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
  ...
  USUARIO_MODIFICACION varchar(30) DEFAULT NULL,
  ESTADO_REGISTRO varchar(1) DEFAULT NULL,
  ES_DGTAL int(11) DEFAULT NULL,
  REP_PADRE decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_reparticion_seleccionada`
--

DROP TABLE IF EXISTS sade_reparticion_seleccionada;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_reparticion_seleccionada (
  ID_REPARTICION_SELECCIONADA int(10) NOT NULL,
  ID_REPARTICION int(10) NOT NULL,
  NOMBRE_USUARIO varchar(30) NOT NULL,
  ID_SECTOR_INTERNO int(10) NOT NULL,
...
--
-- Table structure for table `sade_reparticion_uai`
--

DROP TABLE IF EXISTS sade_reparticion_uai;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_reparticion_uai (
  ID_REPARTICION_UAI int(10) NOT NULL,
  ID_REPARTICION decimal(10,0) NOT NULL,
  ID_UAI decimal(10,0) NOT NULL,
  VERSION decimal(10,0) NOT NULL,
  FECHA_CREACION datetime NOT NULL,
  USUARIO_CREACION varchar(30) DEFAULT NULL,
  FECHA_MODIFICACION datetime DEFAULT NULL,
  USUARIO_MODIFICACION varchar(30) DEFAULT NULL,
  ESTADO_REGISTRO varchar(1) DEFAULT NULL,
  PRIMARY KEY (ID_REPARTICION_UAI)
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_sector_interno`
--

DROP TABLE IF EXISTS sade_sector_interno;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_sector_interno (
  ID_SECTOR_INTERNO int(10) NOT NULL,
  CODIGO_SECTOR_INTERNO varchar(100) NOT NULL,
  NOMBRE_SECTOR_INTERNO varchar(120) NOT NULL,
  CALLE varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `sade_sector_interno_audi`
--

DROP TABLE IF EXISTS sade_sector_interno_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_sector_interno_audi (
  ID_SECTOR_INTERNO_AUDI decimal(10,0) NOT NULL,
  CODIGO_SECTOR_INTERNO varchar(100) NOT NULL,
  NOMBRE_SECTOR_INTERNO varchar(120) NOT NULL,
  CALLE decimal(10,0) DEFAULT NULL,
  NUMERO varchar(10) DEFAULT NULL,
  PISO varchar(40) DEFAULT NULL,
  OFICINA varchar(255) DEFAULT NULL,
  TELEFONO varchar(40) DEFAULT NULL,
  ...
  SECTOR_MESA varchar(1) DEFAULT NULL,
  VERSION decimal(10,0) NOT NULL,
  CODIGO_REPARTICION decimal(10,0) DEFAULT NULL,
  FECHA_A datetime DEFAULT NULL,
  FUNCION_A varchar(1) NOT NULL,
  USUARIO_A varchar(20) NOT NULL,
  ID_SECTOR_INTERNO_A decimal(10,0) NOT NULL,
...
--
-- Table structure for table `sade_sector_reparticion`
--

DROP TABLE IF EXISTS sade_sector_reparticion;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_sector_reparticion (
  ID_SECTOR_REPARTICION decimal(10,0) NOT NULL,
  ID_SECTOR_INTERNO decimal(10,0) NOT NULL,
  ID_REPARTICION decimal(10,0) NOT NULL,
  VERSION decimal(10,0) DEFAULT NULL
);
...
--
-- Table structure for table `sade_sector_reparticion_audi`
--

DROP TABLE IF EXISTS sade_sector_reparticion_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_sector_reparticion_audi (
  ID_SECTOR_REPARTICION_AUDI decimal(10,0) NOT NULL,
  ID_SECTOR_INTERNO_AUDI decimal(10,0) NOT NULL,
  VERSION decimal(10,0) NOT NULL,
  FECHA_A datetime DEFAULT NULL,
  FUNCION_A varchar(1) NOT NULL,
...
--
-- Table structure for table `sade_sector_usuario`
--

DROP TABLE IF EXISTS sade_sector_usuario;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_sector_usuario (
  ID_SECTOR_USUARIO int(10) NOT NULL,
  ID_SECTOR_INTERNO int(10) NOT NULL,
  NOMBRE_USUARIO varchar(255) NOT NULL,
  PROCESO varchar(40) DEFAULT NULL,
...
--
-- Table structure for table `sade_sector_usuario_audi`
--

DROP TABLE IF EXISTS sade_sector_usuario_audi;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_sector_usuario_audi (
  ID_SECTOR_USUARIO_AUDI decimal(10,0) NOT NULL,
  ID_SECTOR_INTERNO decimal(10,0) NOT NULL,
  NOMBRE_USUARIO varchar(255) NOT NULL,
  ...
  USUARIO_A varchar(20) NOT NULL,
  ID_SECTOR_INTERNO_A decimal(10,0) NOT NULL,
  ID_SECTOR_USUARIO decimal(10,0) NOT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_sector_usuario_hist`
--

DROP TABLE IF EXISTS sade_sector_usuario_hist;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_sector_usuario_hist (
  ID_SECTOR_USUARIO decimal(10,0) NOT NULL,
  ID_SECTOR_INTERNO decimal(10,0) DEFAULT NULL,
  NOMBRE_USUARIO varchar(255) DEFAULT NULL,
  PROCESO varchar(40) DEFAULT NULL,
...
--
-- Table structure for table `sade_secuencia`
--

DROP TABLE IF EXISTS sade_secuencia;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_secuencia (
  ID_SECUENCIA decimal(10,0) NOT NULL,
  CODIGO_SECUENCIA varchar(3) NOT NULL,
  NOMBRE_SECUENCIA varchar(20) DEFAULT NULL,
  VIGENCIA_DESDE datetime NOT NULL,
  VIGENCIA_HASTA datetime NOT NULL,
  VERSION decimal(10,0) NOT NULL,
  FECHA_CREACION datetime DEFAULT NULL,
...
--
-- Table structure for table `sade_tipo_documento`
--

DROP TABLE IF EXISTS sade_tipo_documento;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_tipo_documento (
  ID_TIPO_DOCUMENTO decimal(10,0) NOT NULL,
  CODIGO_DOCUMENTO varchar(4) NOT NULL,
...
--
-- Table structure for table `sade_uai`
--

DROP TABLE IF EXISTS sade_uai;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_uai (
  ID_UAI int(10) NOT NULL,
  CODIGO varchar(9) NOT NULL,
  DESCRIPCION varchar(70) NOT NULL,
  FECHA_CREACION datetime NOT NULL,
...
--
-- Table structure for table `sade_ultimo_logueo_usuario`
--

DROP TABLE IF EXISTS sade_ultimo_logueo_usuario;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_ultimo_logueo_usuario (
  NOMBRE_USUARIO varchar(255) NOT NULL,
  FECHA_HORA_ULTIMO_LOGUEO datetime NOT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `sade_upd_sec_rep_work`
--

DROP TABLE IF EXISTS sade_upd_sec_rep_work;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_upd_sec_rep_work (
  FECHA_INICIO datetime DEFAULT NULL,
  FECHA_UPD datetime DEFAULT NULL,
  CANT_LEIDO decimal(10,0) DEFAULT NULL,
  ID_EXPEDIENTE_ULTIMO decimal(10,0) DEFAULT NULL
...
--
-- Table structure for table `sade_upd_sec_repar_log`
--

DROP TABLE IF EXISTS sade_upd_sec_repar_log;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_upd_sec_repar_log (
  ID_EXPEDIENTE decimal(10,0) NOT NULL,
  CODIGO_EXPEDIENTE varchar(100) NOT NULL,
  ID_ACTUACION decimal(10,0) DEFAULT NULL,
...
--
-- Table structure for table `sade_usr_repa_habilitada`
--

DROP TABLE IF EXISTS sade_usr_repa_habilitada;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_usr_repa_habilitada (
  ID_USR_REPA_HABILITADA int(10) NOT NULL,
  ID_REPARTICION int(10) DEFAULT NULL,
  NOMBRE_USUARIO varchar(255) DEFAULT NULL,
  ID_SECTOR_INTERNO int(10) DEFAULT NULL,
...
--
-- Table structure for table `sade_usr_repa_habilitada_hist`
--

DROP TABLE IF EXISTS sade_usr_repa_habilitada_hist;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sade_usr_repa_habilitada_hist (
  ID_USR_REPA_HABILITADA decimal(10,0) DEFAULT NULL,
  ID_REPARTICION decimal(10,0) DEFAULT NULL,
  NOMBRE_USUARIO varchar(255) DEFAULT NULL,
  ID_SECTOR_INTERNO decimal(10,0) DEFAULT NULL,
  REVISION decimal(10,0) NOT NULL,
...
--
-- Table structure for table `sector_interno_aux`
--

DROP TABLE IF EXISTS sector_interno_aux;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE sector_interno_aux (
  ID_SECTOR_INTERNO decimal(10,0) DEFAULT NULL,
  CODIGO_REPARTICION varchar(9) NOT NULL,
  ID_REPARTICION decimal(10,0) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2017-08-30 10:24:51
...
-- Dump completed on 2017-08-30 10:24:52
...
CREATE TABLE actividad (
  ID int(19) NOT NULL COMMENT 'Id de la tabla',
...
CREATE TABLE documento (
  ...
  KEY DOCUMENTOMOTIVOIDX (MOTIVO(333)),
...
CREATE TABLE migr_datatype_transform_map (
  ...
  MAP_NAME varchar(4000) DEFAULT NULL,
...
CREATE TABLE migrlog (
  ...
  REF_OBJECT_TYPE varchar(4000) DEFAULT NULL,
...
CREATE TABLE te_expedient_transaction (
  ID int(19) NOT NULL,
  ID_EXPEDIENT int(19) DEFAULT NULL,
...
CREATE TABLE te_subprocess (
  ...
  CONSTRAINT FK_TRATA_ID FOREIGN KEY (ID_PROCEDURE) REFERENCES trata (ID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE te_subprocess_production (
  ...
  CONSTRAINT FK_TRATA FOREIGN KEY (ID_PROCEDURE) REFERENCES trata (ID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `transaction_esb`
--

DROP TABLE IF EXISTS transaction_esb;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
-- Dump completed on 2017-08-30 10:24:53
