...
public class ExternalPagingSorting {
	Logger logger = LoggerFactory.getLogger(ExternalPagingSorting.class);
	...
	/**
	 * Restablece los íconos de ordenamiento de los encabezados, para que solo
	 * se indique el ordenamiento de la última columna por la cual se ordenó.
	 * 
	 * @param listHeaderActual
	 *            ListHeader actual, por el cual se realizó el último
	 *            ordenamiento.
	 */
	 ...
	 * String inicioCarga. - String tamañoPaginacion. - String criterio. -
	 * String orden. Los parámetros de búsqueda se almacenan en un
	 * HashMap<String,?>.
	 */
	public List<?> cargarDatos() {
		Integer inicioCarga = criterio.equals("createTime") ? paginador.getActivePage() * paginador.getPageSize() :  paginador.getActivePage();
