...
@Entity
@Table(name = "CC_MERCANCIA")
public class Mercancia extends AbstractCComplejoJPA {

	@Column(name = "ID_MERCANCIA")
	Long idMercancia;

	@Column(name = "MERCANCIA_NACIONALIZADA")
	Long mercanciaNacionalizada;

	@Column(name = "REGION_ORIGEN")
	String regionOrigen;

	@Column(name = "PROPIOS_MEDIOS")
	Long propiosMedios;

	@Column(name = "MERCANCIA_ZONA_PRIMARIA")
	Long mercanciaZonaPrimaria;

	@Column(name = "ADQUIRIDAS_CIF")
	Long adquiridasCIF;

	@Column(name = "ORIGEN_CIF")
	Long origenCIF;
