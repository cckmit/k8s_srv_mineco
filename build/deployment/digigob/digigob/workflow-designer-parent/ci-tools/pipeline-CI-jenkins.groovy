node {
    ...
    def gitRepoName = 'workflow-designer-parent.git'
    echo 'gitRepoName = ' + gitRepoName
    
    def deploymentProjectName = 'wd-web'
    echo 'deploymentProjectName = ' + deploymentProjectName
    
    def serverName = 'server3'
    ...
    def pathToSonarProperties = './ci-tools/sonar-project-eGov-workflow-designer-parent.properties'
    ...
    try {
        ...
        stage ( 'deploy' ) {
                ...
                sh 'scp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -i ' + identity_file + ' ./workflow-designer-webapp/target/' + deploymentProjectName + '.war root@' + eGoverisServerDesarrolloDNS + ':' + serverWebApps
