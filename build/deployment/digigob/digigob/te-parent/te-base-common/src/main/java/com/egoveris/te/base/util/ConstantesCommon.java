...
public class ConstantesCommon {
	...
	*/
	...
	public static final String SCRIPT_FORM = "Form";
	public static final String SCRIPT_FORM_VALUES = "FFDD";
	public static final String SCRIPT_WINDOW_PASE = "windowPase";
	public static final String SCRIPT_TYPE_REQUEST = "typeRequest";
	public static final String SCRIPT_NAME_FFCC = "nameFFCC";
	public static final String SCRIPT_ID_TRANS_FFCC = "idTransactionFFCC";
	
	private ConstantesCommon() {
	  // Private constructor
	}
}
