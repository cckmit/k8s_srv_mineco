...
public class FormularioComponenteDTO implements Serializable, Comparable<FormularioComponenteDTO> {
	...
	public static final String TEXTBOX_MULTILINEA_EDITABLE = "TextBox - Multilinea Editable";

	public FormularioComponenteDTO clone() {
		FormularioComponenteDTO clonado = new FormularioComponenteDTO();
	...
	@Override
	public int compareTo(FormularioComponenteDTO o) {
	...
	public boolean isMultilineaEditable() {
		return getComponente().getNombre().equals(TEXTBOX_MULTILINEA_EDITABLE);
	}
