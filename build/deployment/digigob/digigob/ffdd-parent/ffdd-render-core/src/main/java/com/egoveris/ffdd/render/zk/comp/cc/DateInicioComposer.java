...
public class DateInicioComposer extends ComplexComponentComposer {

	private static final long serialVersionUID = 8989623688678301110L;
	private static final Logger LOGGER = LoggerFactory.getLogger(DateInicioComposer.class);
	...
	private void settearFecha(Optional<List<LocalDate>> holidays) {
		if (validateFecha(holidays)) {
			throw new WrongValueException(this.fecha,
					"La fecha de inicio no debe ser anterior a más de 3 días hábiles de la fecha actual");
		}
	}
