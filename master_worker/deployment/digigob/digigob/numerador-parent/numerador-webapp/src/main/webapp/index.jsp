...
// Spring Web Flow
try {
	Class.forName("com.egoveris.numerador.webapp.service.DummyWebFlowService");
...
// Apache Tiles
try {
	Class.forName("com.egoveris.numerador.webapp.controller.DummyTilesController");
...
<head><title>numerador</title></head>
