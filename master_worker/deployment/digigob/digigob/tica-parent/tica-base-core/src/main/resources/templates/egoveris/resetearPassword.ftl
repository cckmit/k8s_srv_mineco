      ...
      <tbody>
        <tr>
          ...
          <td style="background-color: rgb(154, 202 , 60); text-align: center;">
            <span style="font-size: 24px">
              <b>eGoveris</b> - Administraci&oacute;n de Usuarios
            </span>
          </td>
        </tr>
        ...
        <tr>
          <td style="text-align: justify;" colspan="2">
            ...
            <br>
            <br>
            Por este medio se le notifica que se le ha reseteado la contrase&ntilde;a para los sistemas eGoveris:
            <br>
           ...
           <br>
            El presente es un mensaje generado autom&aacute;ticamente por el <b>Sistema de Administraci&oacute;n de Usuarios eGoveris</b> y no debe ser respondido.
            <br>
            </span>
