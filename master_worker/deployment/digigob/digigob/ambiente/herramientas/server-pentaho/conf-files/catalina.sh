...
CATALINA_OPTS="-Xmx5120M"

#JRE_HOME=/opt/jre-ibm/jre
JAVA_OPTS="${JAVA_OPTS} ${GC_LOG_OPTS}  -Dsolr.solr.home=/solr-home -Dsolr.allow.unsafe.resourceloading=true  -XX:-UseSuperWord \
-XX:NewRatio=3 \
-XX:SurvivorRatio=4 \
...
-XX:+AggressiveOpts "
#JAVA_OPTS=$JAVA_OPTS  " -XX:ParallelGCThreads=2; -XX:+UseConcMarkSweepGC; -XX:+UseParNewGC; -XX:SurvivorRatio=8; -XX:TargetSurvivorRatio=75"
