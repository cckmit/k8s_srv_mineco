...
--
-- Table structure for table `numerador_flyway`
--

DROP TABLE IF EXISTS numerador_flyway;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE numerador_flyway (
  id int(11) DEFAULT NULL,
  glosa varchar(20) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `edt_flyway`
--

DROP TABLE IF EXISTS edt_flyway;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE edt_flyway (
  id int(11) DEFAULT NULL,
  glosa varchar(20) DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE edt_sade_admin_reparticion (
  ID_ADMIN_REPARTICION int(11) NOT NULL,
...
CREATE TABLE edt_sade_reparticion_seleccionada (
  ID_REPARTICION_SELECCIONADA int(10) NOT NULL DEFAULT '0',
  ID_REPARTICION int(10) NOT NULL,
  NOMBRE_USUARIO varchar(30) NOT NULL,
...
CREATE TABLE edt_sade_uai (
  ID_UAI int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE edt_sade_usr_repa_habilitada (
  ID_USR_REPA_HABILITADA int(11) NOT NULL,
  ID_REPARTICION int(10) DEFAULT NULL,
...
CREATE TABLE actividad (
  ...
  ID_TIPO_ACTIVIDAD decimal(19,0) DEFAULT NULL,
  ESTADO varchar(255) DEFAULT NULL,
...
CREATE TABLE actividad_param (
  ID int(19) NOT NULL,
  ID_ACTIVIDAD decimal(19,0) DEFAULT NULL,
...
CREATE TABLE dato_variable (
  ID_TRATA decimal(10,0) NOT NULL,
...
CREATE TABLE datos_variables_combos (
  ID decimal(10,0) NOT NULL,
  ID_GRUPO_COMBO decimal(10,0) NOT NULL,
...
CREATE TABLE documento (
  ...
  ID_TIPO_DOCUMENTO_VINCULADO decimal(10,0) DEFAULT NULL,
  ...
  ID_TRANSACCION_FC decimal(10,0) DEFAULT NULL,
...
CREATE TABLE ee_arch_trabajo_visu_test (
  ...
  FECHA_ALTA datetime DEFAULT NULL,
  ID_ARCHIVO_TRABAJO double DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE ee_archivo_remision (
  ...
  ID_EXPEDIENTE_REMISION double NOT NULL,
...
CREATE TABLE ee_aud_tarea_migracion_error (
  ID int(10) NOT NULL,
  ID_TAREA decimal(10,0) DEFAULT NULL,
...
CREATE TABLE ee_auditoria_notificacion (
  ...
  ID_DOCUMENTO decimal(10,0) DEFAULT NULL,
...
CREATE TABLE ee_con_suspension (
  ...
  UNIQUE KEY EE_CON_SUSPENSION_PK (ID),
  KEY FK51AC8C59AE21D949 (ID),
  KEY FK51AC8C597753DDDD (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE ee_expediente_archivostrabajo (
  ID decimal(10,0) NOT NULL,
  ID_ARCHIVOTRABAJO decimal(10,0) NOT NULL,
...
CREATE TABLE ee_expediente_documentos (
  ...
  POSICION decimal(10,0) NOT NULL,
  ID_EE_DOC decimal(10,0) DEFAULT NULL,
...
CREATE TABLE ee_expediente_electronico (
  ID int(10) NOT NULL,
  DESCRIPCION varchar(255) DEFAULT NULL,
  ID_TRATA decimal(10,0) DEFAULT NULL,
  ...
  ID_OPERACION bigint(23) DEFAULT NULL,
  PRIMARY KEY (ID),
...
CREATE TABLE expedienteasociado (
  ...
  CODIGO_REPARTICION_USUARIO varchar(255) DEFAULT NULL,
  ES_ELECTRONICO char(1) DEFAULT NULL,
  ID_CODIGO_CARATULA decimal(10,0) DEFAULT NULL,
  FECHA_ASOCIACION datetime DEFAULT NULL,
  USUARIO_ASOCIADOR varchar(255) DEFAULT NULL,
  ID_TASK varchar(255) DEFAULT NULL,
...
CREATE TABLE historialoperacion (
  ...
  ID_EXPEDIENTE_ELECTRONICO int(10) DEFAULT NULL,
...
CREATE TABLE solicitud_expediente (
  ...
  FECHA_CREACION datetime DEFAULT NULL,
  ID_TRATA_SUGERIDA decimal(10,0) DEFAULT NULL,
...
CREATE TABLE te_expediente_formulario (
  ID_DF_TRANSACTION int(19) DEFAULT NULL,
  ID_EE_EXPEDIENT int(10) NOT NULL DEFAULT '0',
  ID_DEF_FORM int(19) DEFAULT NULL,
  DATE_CREATION datetime DEFAULT NULL,
...
CREATE TABLE te_operacion_ee (
  ...
  ID_SUBPROCESO bigint(20) DEFAULT NULL,
  ID_EXPEDIENTE_ELECTRONICO bigint(20) DEFAULT NULL,
...
CREATE TABLE te_tipo_oper_form (
  ...
  ID_TIPO_OPERACION int(10) NOT NULL,
...
CREATE TABLE tipo_documento (
  ...
  ID_TIPO_DOCUMENTOSADE int(10) DEFAULT NULL,
...
CREATE TABLE trata_tipo_documento (
  ID_TRATA_TIPO_DOCUMENTO int(10) NOT NULL,
  ACRONIMO_GEDO varchar(255) DEFAULT NULL,
  TRATA int(10) NOT NULL,
...
CREATE TABLE tad_apoderado_persona (
  ID int(19) NOT NULL,
  ID_TITULAR decimal(19,0) NOT NULL,
  ID_APODERADO decimal(19,0) NOT NULL,
...
CREATE TABLE tad_expediente_base (
  ...
  SE_VA_A_REINTENTAR int(11) DEFAULT NULL,
  FECHA_INICIO datetime DEFAULT NULL,
  PRIMARY KEY (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tad_tipo_documento (
  ...
  INCLUIDO_EN_SUPERTRATA int(11) DEFAULT NULL,
  FIRMA_CON_TOKEN int(11) DEFAULT NULL,
  PRIMARY KEY (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tad_tipo_tramite (
  ...
  ID_TRAMITE_TURNO double DEFAULT NULL,
  ARCHIVO_TRABAJO int(11) NOT NULL,
  INTERVINIENTE char(1) NOT NULL,
  PREVALIDACION char(1) NOT NULL,
  SUPER_TRATA char(1) DEFAULT NULL,
  DIAS_GUARDADO double DEFAULT NULL,
  PRIMARY KEY (ID)
);
/*!40101 SET character_set_client = @saved_cs_client */;
