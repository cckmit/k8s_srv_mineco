CREATE DATABASE  IF NOT EXISTS `qa_numerador_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `qa_numerador_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: qa_numerador_trade
-- ------------------------------------------------------
...
/*!50001 VIEW sade_sector_usuario AS select qa_edt_trade.edt_sade_sector_usuario.ID_SECTOR_USUARIO AS ID_SECTOR_USUARIO,qa_edt_trade.edt_sade_sector_usuario.ID_SECTOR_INTERNO AS ID_SECTOR_INTERNO,qa_edt_trade.edt_sade_sector_usuario.NOMBRE_USUARIO AS NOMBRE_USUARIO,qa_edt_trade.edt_sade_sector_usuario.PROCESO AS PROCESO,qa_edt_trade.edt_sade_sector_usuario.ESTADO_REGISTRO AS ESTADO_REGISTRO,qa_edt_trade.edt_sade_sector_usuario.VERSION AS VERSION,qa_edt_trade.edt_sade_sector_usuario.FECHA_CREACION AS FECHA_CREACION,qa_edt_trade.edt_sade_sector_usuario.USUARIO_CREACION AS USUARIO_CREACION,qa_edt_trade.edt_sade_sector_usuario.FECHA_MODIFICACION AS FECHA_MODIFICACION,qa_edt_trade.edt_sade_sector_usuario.USUARIO_MODIFICACION AS USUARIO_MODIFICACION,qa_edt_trade.edt_sade_sector_usuario.CARGO_ID AS CARGO_ID from qa_edt_trade.edt_sade_sector_usuario */;
...
CREATE DATABASE  IF NOT EXISTS `qa_vuc_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `qa_vuc_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: qa_vuc_trade
-- ------------------------------------------------------
-- Server version	5.7.18
...
-- Dump completed on 2017-08-30 10:00:25
CREATE DATABASE  IF NOT EXISTS `qa_deo_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `qa_deo_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: qa_deo_trade
-- ------------------------------------------------------
-- Server version	5.7.18
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=temuco@`%` SQL SECURITY DEFINER */
/*!50001 VIEW property_configuration AS select qa_edt_trade.property_configuration.CLAVE AS CLAVE,qa_edt_trade.property_configuration.VALOR AS VALOR,qa_edt_trade.property_configuration.CONFIGURACION AS CONFIGURACION from qa_edt_trade.property_configuration */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
CREATE DATABASE  IF NOT EXISTS `qa_te_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `qa_te_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: qa_te_trade
-- ------------------------------------------------------
-- Server version	5.7.18
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=temuco@`%` SQL SECURITY DEFINER */
/*!50001 VIEW sade_reparticion AS select qa_edt_trade.edt_sade_reparticion.id_reparticion AS id_reparticion,qa_edt_trade.edt_sade_reparticion.CODIGO_REPARTICION AS CODIGO_REPARTICION,qa_edt_trade.edt_sade_reparticion.CODIGO_REPAR_INTER AS CODIGO_REPAR_INTER,qa_edt_trade.edt_sade_reparticion.NOMBRE_REPARTICION AS NOMBRE_REPARTICION,qa_edt_trade.edt_sade_reparticion.VIGENCIA_DESDE AS VIGENCIA_DESDE,qa_edt_trade.edt_sade_reparticion.VIGENCIA_HASTA AS VIGENCIA_HASTA,qa_edt_trade.edt_sade_reparticion.NUMERO AS NUMERO,qa_edt_trade.edt_sade_reparticion.PISO AS PISO,qa_edt_trade.edt_sade_reparticion.OFICINA AS OFICINA,qa_edt_trade.edt_sade_reparticion.TELEFONO AS TELEFONO,qa_edt_trade.edt_sade_reparticion.FAX AS FAX,qa_edt_trade.edt_sade_reparticion.EMAIL AS EMAIL,qa_edt_trade.edt_sade_reparticion.ID_ESTRUCTURA AS ID_ESTRUCTURA,qa_edt_trade.edt_sade_reparticion.EN_RED AS EN_RED,qa_edt_trade.edt_sade_reparticion.SECTOR_MESA AS SECTOR_MESA,qa_edt_trade.edt_sade_reparticion.VERSION AS VERSION,qa_edt_trade.edt_sade_reparticion.FECHA_CREACION AS FECHA_CREACION,qa_edt_trade.edt_sade_reparticion.USUARIO_CREACION AS USUARIO_CREACION,qa_edt_trade.edt_sade_reparticion.FECHA_MODIFICACION AS FECHA_MODIFICACION,qa_edt_trade.edt_sade_reparticion.USUARIO_MODIFICACION AS USUARIO_MODIFICACION,qa_edt_trade.edt_sade_reparticion.ESTADO_REGISTRO AS ESTADO_REGISTRO,qa_edt_trade.edt_sade_reparticion.ES_DGTAL AS ES_DGTAL,qa_edt_trade.edt_sade_reparticion.REP_PADRE AS REP_PADRE,qa_edt_trade.edt_sade_reparticion.COD_DGTAL AS COD_DGTAL,qa_edt_trade.edt_sade_reparticion.ID_JURISDICCION AS ID_JURISDICCION,qa_edt_trade.edt_sade_reparticion.MINISTERIO AS MINISTERIO,qa_edt_trade.edt_sade_reparticion.ADMINISTRADOR_PRESUPUESTO AS ADMINISTRADOR_PRESUPUESTO,qa_edt_trade.edt_sade_reparticion.calle AS calle from qa_edt_trade.edt_sade_reparticion */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-08-30 10:00:27
CREATE DATABASE  IF NOT EXISTS `qa_mnt_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `qa_mnt_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: qa_mnt_trade
-- ------------------------------------------------------
-- Server version	5.7.18
...
CREATE DATABASE  IF NOT EXISTS `qa_edt_trade` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `qa_edt_trade`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: qa_edt_trade
-- ------------------------------------------------------
-- Server version	5.7.18
