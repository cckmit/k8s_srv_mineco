CREATE DATABASE  IF NOT EXISTS `dm_numerador_egov` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dm_numerador_egov`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dm_numerador_egov
-- ------------------------------------------------------
...
/*!50001 VIEW sade_sector_usuario AS select dm_edt_egov.edt_sade_sector_usuario.ID_SECTOR_USUARIO AS ID_SECTOR_USUARIO,dm_edt_egov.edt_sade_sector_usuario.ID_SECTOR_INTERNO AS ID_SECTOR_INTERNO,dm_edt_egov.edt_sade_sector_usuario.NOMBRE_USUARIO AS NOMBRE_USUARIO,dm_edt_egov.edt_sade_sector_usuario.PROCESO AS PROCESO,dm_edt_egov.edt_sade_sector_usuario.ESTADO_REGISTRO AS ESTADO_REGISTRO,dm_edt_egov.edt_sade_sector_usuario.VERSION AS VERSION,dm_edt_egov.edt_sade_sector_usuario.FECHA_CREACION AS FECHA_CREACION,dm_edt_egov.edt_sade_sector_usuario.USUARIO_CREACION AS USUARIO_CREACION,dm_edt_egov.edt_sade_sector_usuario.FECHA_MODIFICACION AS FECHA_MODIFICACION,dm_edt_egov.edt_sade_sector_usuario.USUARIO_MODIFICACION AS USUARIO_MODIFICACION,dm_edt_egov.edt_sade_sector_usuario.CARGO_ID AS CARGO_ID from dm_edt_egov.edt_sade_sector_usuario */;
...
CREATE DATABASE  IF NOT EXISTS `dm_vuc_egov` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dm_vuc_egov`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dm_vuc_egov
-- ------------------------------------------------------
-- Server version	5.7.18
...
-- Dump completed on 2017-08-30 10:00:25
CREATE DATABASE  IF NOT EXISTS `dm_deo_egov` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dm_deo_egov`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dm_deo_egov
-- ------------------------------------------------------
-- Server version	5.7.18
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=temuco@`%` SQL SECURITY DEFINER */
/*!50001 VIEW property_configuration AS select dm_edt_egov.property_configuration.CLAVE AS CLAVE,dm_edt_egov.property_configuration.VALOR AS VALOR,dm_edt_egov.property_configuration.CONFIGURACION AS CONFIGURACION from dm_edt_egov.property_configuration */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
CREATE DATABASE  IF NOT EXISTS `dm_te_egov` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dm_te_egov`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dm_te_egov
-- ------------------------------------------------------
-- Server version	5.7.18
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=temuco@`%` SQL SECURITY DEFINER */
/*!50001 VIEW gedo_documento AS select dm_deo_egov.gedo_documento.ID AS ID,dm_deo_egov.gedo_documento.NUMERO AS NUMERO,dm_deo_egov.gedo_documento.NUMEROESPECIAL AS NUMEROESPECIAL,dm_deo_egov.gedo_documento.REPARTICION AS REPARTICION,dm_deo_egov.gedo_documento.ANIO AS ANIO,dm_deo_egov.gedo_documento.MOTIVO AS MOTIVO,dm_deo_egov.gedo_documento.USUARIOGENERADOR AS USUARIOGENERADOR,dm_deo_egov.gedo_documento.FECHACREACION AS FECHACREACION,dm_deo_egov.gedo_documento.WORKFLOWORIGEN AS WORKFLOWORIGEN,dm_deo_egov.gedo_documento.NUMERO_SADE_PAPEL AS NUMERO_SADE_PAPEL,dm_deo_egov.gedo_documento.TIPO AS TIPO,dm_deo_egov.gedo_documento.SISTEMAORIGEN AS SISTEMAORIGEN,dm_deo_egov.gedo_documento.SISTEMAINICIADOR AS SISTEMAINICIADOR,dm_deo_egov.gedo_documento.USUARIOINICIADOR AS USUARIOINICIADOR,dm_deo_egov.gedo_documento.TIPORESERVA AS TIPORESERVA,dm_deo_egov.gedo_documento.VERSION AS VERSION,dm_deo_egov.gedo_documento.CCOO_ID_DOC AS CCOO_ID_DOC,dm_deo_egov.gedo_documento.CCOO_FECHA_CREACION AS CCOO_FECHA_CREACION,dm_deo_egov.gedo_documento.APODERADO AS APODERADO,dm_deo_egov.gedo_documento.REPARTICION_ACTUAL AS REPARTICION_ACTUAL,dm_deo_egov.gedo_documento.FECHA_MODIFICACION AS FECHA_MODIFICACION,dm_deo_egov.gedo_documento.ID_GUARDA_DOCUMENTAL AS ID_GUARDA_DOCUMENTAL,dm_deo_egov.gedo_documento.PESO AS PESO,dm_deo_egov.gedo_documento.MOTIVO_DEPURACION AS MOTIVO_DEPURACION,dm_deo_egov.gedo_documento.FECHA_DEPURACION AS FECHA_DEPURACION from dm_deo_egov.gedo_documento */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=temuco@`%` SQL SECURITY DEFINER */
/*!50001 VIEW gedo_tipodocumento AS select dm_deo_egov.gedo_tipodocumento.ID AS ID,dm_deo_egov.gedo_tipodocumento.NOMBRE AS NOMBRE,dm_deo_egov.gedo_tipodocumento.ACRONIMO AS ACRONIMO,dm_deo_egov.gedo_tipodocumento.DESCRIPCION AS DESCRIPCION,dm_deo_egov.gedo_tipodocumento.ESESPECIAL AS ESESPECIAL,dm_deo_egov.gedo_tipodocumento.TIENETOKEN AS TIENETOKEN,dm_deo_egov.gedo_tipodocumento.TIENETEMPLATE AS TIENETEMPLATE,dm_deo_egov.gedo_tipodocumento.ESTADO AS ESTADO,dm_deo_egov.gedo_tipodocumento.IDTIPODOCUMENTOSADE AS IDTIPODOCUMENTOSADE,dm_deo_egov.gedo_tipodocumento.CODIGOTIPODOCUMENTOSADE AS CODIGOTIPODOCUMENTOSADE,dm_deo_egov.gedo_tipodocumento.ESCONFIDENCIAL AS ESCONFIDENCIAL,dm_deo_egov.gedo_tipodocumento.ESFIRMAEXTERNA AS ESFIRMAEXTERNA,dm_deo_egov.gedo_tipodocumento.ESMANUAL AS ESMANUAL,dm_deo_egov.gedo_tipodocumento.ESAUTOMATICA AS ESAUTOMATICA,dm_deo_egov.gedo_tipodocumento.ESFIRMACONJUNTA AS ESFIRMACONJUNTA,dm_deo_egov.gedo_tipodocumento.FAMILIA AS FAMILIA,dm_deo_egov.gedo_tipodocumento.TIENEAVISO AS TIENEAVISO,dm_deo_egov.gedo_tipodocumento.PERMITE_EMBEBIDOS AS PERMITE_EMBEBIDOS,dm_deo_egov.gedo_tipodocumento.TIPOPRODUCCION AS TIPOPRODUCCION,dm_deo_egov.gedo_tipodocumento.ES_NOTIFICABLE AS ES_NOTIFICABLE,dm_deo_egov.gedo_tipodocumento.VERSION AS VERSION,dm_deo_egov.gedo_tipodocumento.TAMANO AS TAMANO,dm_deo_egov.gedo_tipodocumento.ESOCULTO AS ESOCULTO,dm_deo_egov.gedo_tipodocumento.ES_COMUNICABLE AS ES_COMUNICABLE,dm_deo_egov.gedo_tipodocumento.USUARIO_CREADOR AS USUARIO_CREADOR,dm_deo_egov.gedo_tipodocumento.FECHA_CREACION AS FECHA_CREACION,dm_deo_egov.gedo_tipodocumento.ESFIRMAEXTERNACONENCABEZADO AS ESFIRMAEXTERNACONENCABEZADO from dm_deo_egov.gedo_tipodocumento */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=temuco@`%` SQL SECURITY DEFINER */
/*!50001 VIEW sade_reparticion AS select dm_edt_egov.edt_sade_reparticion.id_reparticion AS id_reparticion,dm_edt_egov.edt_sade_reparticion.CODIGO_REPARTICION AS CODIGO_REPARTICION,dm_edt_egov.edt_sade_reparticion.CODIGO_REPAR_INTER AS CODIGO_REPAR_INTER,dm_edt_egov.edt_sade_reparticion.NOMBRE_REPARTICION AS NOMBRE_REPARTICION,dm_edt_egov.edt_sade_reparticion.VIGENCIA_DESDE AS VIGENCIA_DESDE,dm_edt_egov.edt_sade_reparticion.VIGENCIA_HASTA AS VIGENCIA_HASTA,dm_edt_egov.edt_sade_reparticion.NUMERO AS NUMERO,dm_edt_egov.edt_sade_reparticion.PISO AS PISO,dm_edt_egov.edt_sade_reparticion.OFICINA AS OFICINA,dm_edt_egov.edt_sade_reparticion.TELEFONO AS TELEFONO,dm_edt_egov.edt_sade_reparticion.FAX AS FAX,dm_edt_egov.edt_sade_reparticion.EMAIL AS EMAIL,dm_edt_egov.edt_sade_reparticion.ID_ESTRUCTURA AS ID_ESTRUCTURA,dm_edt_egov.edt_sade_reparticion.EN_RED AS EN_RED,dm_edt_egov.edt_sade_reparticion.SECTOR_MESA AS SECTOR_MESA,dm_edt_egov.edt_sade_reparticion.VERSION AS VERSION,dm_edt_egov.edt_sade_reparticion.FECHA_CREACION AS FECHA_CREACION,dm_edt_egov.edt_sade_reparticion.USUARIO_CREACION AS USUARIO_CREACION,dm_edt_egov.edt_sade_reparticion.FECHA_MODIFICACION AS FECHA_MODIFICACION,dm_edt_egov.edt_sade_reparticion.USUARIO_MODIFICACION AS USUARIO_MODIFICACION,dm_edt_egov.edt_sade_reparticion.ESTADO_REGISTRO AS ESTADO_REGISTRO,dm_edt_egov.edt_sade_reparticion.ES_DGTAL AS ES_DGTAL,dm_edt_egov.edt_sade_reparticion.REP_PADRE AS REP_PADRE,dm_edt_egov.edt_sade_reparticion.COD_DGTAL AS COD_DGTAL,dm_edt_egov.edt_sade_reparticion.ID_JURISDICCION AS ID_JURISDICCION,dm_edt_egov.edt_sade_reparticion.MINISTERIO AS MINISTERIO,dm_edt_egov.edt_sade_reparticion.ADMINISTRADOR_PRESUPUESTO AS ADMINISTRADOR_PRESUPUESTO,dm_edt_egov.edt_sade_reparticion.calle AS calle from dm_edt_egov.edt_sade_reparticion */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-08-30 10:00:27
CREATE DATABASE  IF NOT EXISTS `dm_mnt_egov` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dm_mnt_egov`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dm_mnt_egov
-- ------------------------------------------------------
-- Server version	5.7.18
...
CREATE DATABASE  IF NOT EXISTS `dm_edt_egov` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dm_edt_egov`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 7.214.8.14    Database: dm_edt_egov
-- ------------------------------------------------------
-- Server version	5.7.18
