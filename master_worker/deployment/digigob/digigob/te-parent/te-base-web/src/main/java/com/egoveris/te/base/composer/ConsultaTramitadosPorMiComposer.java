...
public class ConsultaTramitadosPorMiComposer extends ConsultasComposer {
  /**
  * 
  */
  ...
  protected List<ExpedienteElectronicoDTO> buscar(String username, TrataDTO trata,
    ...
    super.buscar();
    return this.getExpedienteElectronicoService().buscarExpedienteElectronicoPorUsuarioTramitacion(
        username, trata, expedienteMetaDataList, metaDatos, desde, hasta, tipoDocumento,
        this.numeroDocumentotbx.getValue(), cuitCuil, this.getEstado());
