...
//		String barrio;
//		
//		if(solicitud.getSolicitante().getBarrio()!=null
//				&& !solicitud.getSolicitante().getBarrio().equalsIgnoreCase("")){
//			barrio = solicitud.getSolicitante().getBarrio();
//		}else{
//			barrio = "---";
//		}
...
//		String comuna;
//		
//		if(solicitud.getSolicitante().getComuna()!=null
//				&& !solicitud.getSolicitante().getComuna().equalsIgnoreCase("")){
//			comuna = solicitud.getSolicitante().getComuna();
//		}else{
//			comuna = "---";
//		}
...
//			buffer.append("  Barrio: ").append(barrio).append("<br>");
//			buffer.append("  Comuna: ").append(comuna).append("<br><br><br>");
