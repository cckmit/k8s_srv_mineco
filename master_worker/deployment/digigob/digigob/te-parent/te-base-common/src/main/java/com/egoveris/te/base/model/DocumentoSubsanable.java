...
public class DocumentoSubsanable implements Serializable {
	...
	public DocumentoSubsanable() {
	}
	public DocumentoSubsanable(boolean subsanado, boolean subsanadoLimitado) {
