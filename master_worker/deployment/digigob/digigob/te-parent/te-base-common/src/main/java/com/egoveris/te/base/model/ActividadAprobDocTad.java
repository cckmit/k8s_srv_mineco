...
public class ActividadAprobDocTad extends ActividadCommon implements Serializable {
	private static final Logger logger = LoggerFactory.getLogger(ActividadAprobDocTad.class);
